...
// Write respone
    ...
    input  wire [ID_WIDTH-1:0]  axm1_bid,     // Response ID tag
...
// Read data channel
    ...
    input  wire [ID_WIDTH-1:0]  axm1_rid,   // Read response id
// Global signals
//    input  wire        aclk1,
//    input  wire        aresetn1,
...
// Write respone
    ...
    input  wire [ID_WIDTH-1:0]  axm2_bid,     // Response ID tag
...
// Read data channel
    ...
    input  wire [ID_WIDTH-1:0]  axm2_rid,   // Read response id
// Global signals
//    input  wire        aclk2,
//    input  wire        aresetn2   
	input wire aclk,
