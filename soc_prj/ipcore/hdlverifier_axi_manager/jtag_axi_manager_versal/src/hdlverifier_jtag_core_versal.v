`timescale 1 ns / 1 ns
module hdlverifier_jtag_core_versal
(
// Clock
    output tck,
// Reset
...
assign capture_dr   = versal_sel && versal_capture;
assign shift_dr     = versal_sel && versal_shift;
assign update_dr    = versal_sel && versal_update;
