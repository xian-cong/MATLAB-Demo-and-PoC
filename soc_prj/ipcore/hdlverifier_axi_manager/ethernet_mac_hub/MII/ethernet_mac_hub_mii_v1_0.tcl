...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "IPADDR1" -parent ${Page_0}
  ipgui::add_param $IPINST -name "IPADDR2" -parent ${Page_0}
  ipgui::add_param $IPINST -name "IPADDR3" -parent ${Page_0}
  ipgui::add_param $IPINST -name "IPADDR4" -parent ${Page_0}
  ipgui::add_param $IPINST -name "MACADDR" -parent ${Page_0}
  ipgui::add_param $IPINST -name "NUM_AXIS_CHANNELS" -parent ${Page_0}
  ipgui::add_param $IPINST -name "UDP_DSTPORT_FORCH1" -parent ${Page_0}
  ipgui::add_param $IPINST -name "UDP_DSTPORT_FORCH2" -parent ${Page_0}
  ipgui::add_param $IPINST -name "UDP_DSTPORT_FORCH3" -parent ${Page_0}
  ipgui::add_param $IPINST -name "UDP_DSTPORT_FORCH4" -parent ${Page_0}
  ipgui::add_param $IPINST -name "UDP_DSTPORT_FORCH5" -parent ${Page_0}
  ipgui::add_param $IPINST -name "UDP_DSTPORT_FORCH6" -parent ${Page_0}
  ipgui::add_param $IPINST -name "UDP_DSTPORT_FORCH7" -parent ${Page_0}
  ipgui::add_param $IPINST -name "UDP_DSTPORT_FORCH8" -parent ${Page_0}
