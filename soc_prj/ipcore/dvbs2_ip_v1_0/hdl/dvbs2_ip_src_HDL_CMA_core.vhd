-- -------------------------------------------------------------
-- 
-- File Name: C:\demo\DVBS2ReceiverSoCExample\soc_prj\hdlcoder\DVBS2\hdlsrc\soc_dvbs2_fpga\dvbs2_ip_src_HDL_CMA_core.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: dvbs2_ip_src_HDL_CMA_core
-- Source Path: soc_dvbs2_fpga/DVBS2/DVBS2 TxRx/DVB-S2 HDL Receiver/Synchronizer and PL Header Decoder/Time Frequency 
-- and Coarse Phase Synchronizer/Coarse Phase Synchronizer/Coarse Phase Corrector/HDL_CMA_cor
-- Hierarchy Level: 7
-- Model version: 9.0
-- 
...
ENTITY dvbs2_ip_src_HDL_CMA_core IS
...
END dvbs2_ip_src_HDL_CMA_core;


ARCHITECTURE rtl OF dvbs2_ip_src_HDL_CMA_core IS

  -- Component Declarations
  COMPONENT dvbs2_ip_src_Quadrant_Mapper
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_32_0                      :   IN    std_logic;
  ...
  COMPONENT dvbs2_ip_src_CordicKernelMag
  ...
  FOR ALL : dvbs2_ip_src_Quadrant_Mapper
    USE ENTITY work.dvbs2_ip_src_Quadrant_Mapper(rtl);

  FOR ALL : dvbs2_ip_src_CordicKernelMag
    USE ENTITY work.dvbs2_ip_src_CordicKernelMag(rtl);
...
BEGIN
  u_QuadrantMapper : dvbs2_ip_src_Quadrant_Mapper
    PORT MAP( clk => clk,
              reset => reset,
  ...
  u_Iteration : dvbs2_ip_src_CordicKernelMag
  ...
  u_Iteration_1 : dvbs2_ip_src_CordicKernelMag
  ...
  u_Iteration_2 : dvbs2_ip_src_CordicKernelMag
  ...
  u_Iteration_3 : dvbs2_ip_src_CordicKernelMag
  ...
  u_Iteration_4 : dvbs2_ip_src_CordicKernelMag
  ...
  u_Iteration_5 : dvbs2_ip_src_CordicKernelMag
  ...
  u_Iteration_6 : dvbs2_ip_src_CordicKernelMag
  ...
  u_Iteration_7 : dvbs2_ip_src_CordicKernelMag
  ...
  u_Iteration_8 : dvbs2_ip_src_CordicKernelMag
  ...
  u_Iteration_9 : dvbs2_ip_src_CordicKernelMag
  ...
  u_Iteration_10 : dvbs2_ip_src_CordicKernelMag
