-- -------------------------------------------------------------
-- 
-- File Name: C:\demo\DVBS2ReceiverSoCExample\soc_prj\hdlcoder\DVBS2\hdlsrc\soc_dvbs2_fpga\dvbs2_ip_src_NCO_HDL_Optimized_block1.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: dvbs2_ip_src_NCO_HDL_Optimized_block1
-- Source Path: soc_dvbs2_fpga/DVBS2/DVBS2 TxRx/DVB-S2 HDL Receiver/Synchronizer and PL Header Decoder/Time Frequency 
-- and Coarse Phase Synchronizer/Fine Frequency Synchronizer/NCO HDL Optimize
-- Hierarchy Level: 6
-- Model version: 9.0
-- 
-- NCO
...
ENTITY dvbs2_ip_src_NCO_HDL_Optimized_block1 IS
...
END dvbs2_ip_src_NCO_HDL_Optimized_block1;


ARCHITECTURE rtl OF dvbs2_ip_src_NCO_HDL_Optimized_block1 IS

  -- Component Declarations
  COMPONENT dvbs2_ip_src_WaveformGen_block2
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_32_0                      :   IN    std_logic;
  ...
  FOR ALL : dvbs2_ip_src_WaveformGen_block2
    USE ENTITY work.dvbs2_ip_src_WaveformGen_block2(rtl);
...
BEGIN
  u_Wave_inst : dvbs2_ip_src_WaveformGen_block2
    PORT MAP( clk => clk,
              reset => reset,
