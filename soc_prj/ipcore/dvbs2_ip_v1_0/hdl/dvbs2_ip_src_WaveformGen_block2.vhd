-- -------------------------------------------------------------
-- 
-- File Name: C:\demo\DVBS2ReceiverSoCExample\soc_prj\hdlcoder\DVBS2\hdlsrc\soc_dvbs2_fpga\dvbs2_ip_src_WaveformGen_block2.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: dvbs2_ip_src_WaveformGen_block2
-- Source Path: soc_dvbs2_fpga/DVBS2/DVBS2 TxRx/DVB-S2 HDL Receiver/Synchronizer and PL Header Decoder/Time Frequency 
-- and Coarse Phase Synchronizer/Fine Frequency Synchronizer/NCO HDL Optimized/WaveformGe
-- Hierarchy Level: 7
-- Model version: 9.0
-- 
...
ENTITY dvbs2_ip_src_WaveformGen_block2 IS
...
END dvbs2_ip_src_WaveformGen_block2;


ARCHITECTURE rtl OF dvbs2_ip_src_WaveformGen_block2 IS

  -- Component Declarations
  COMPONENT dvbs2_ip_src_CosLookUpTableGen_block2
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_32_0                      :   IN    std_logic;
  ...
  COMPONENT dvbs2_ip_src_SinLookUpTableGen_block2
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_32_0                      :   IN    std_logic;
          lutaddr                         :   IN    std_logic_vector(10 DOWNTO 0);  -- ufix11
  ...
  FOR ALL : dvbs2_ip_src_CosLookUpTableGen_block2
    USE ENTITY work.dvbs2_ip_src_CosLookUpTableGen_block2(rtl);

  FOR ALL : dvbs2_ip_src_SinLookUpTableGen_block2
    USE ENTITY work.dvbs2_ip_src_SinLookUpTableGen_block2(rtl);
...
BEGIN
  u_Cos_Wave_inst : dvbs2_ip_src_CosLookUpTableGen_block2
    PORT MAP( clk => clk,
              reset => reset,
  ...
  u_Sin_Wave_inst : dvbs2_ip_src_SinLookUpTableGen_block2
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_32_0 => enb_1_32_0,
              lutaddr => std_logic_vector(lutaddrO),  -- ufix11
