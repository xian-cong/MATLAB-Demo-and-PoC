-- -------------------------------------------------------------
-- 
-- File Name: C:\demo\DVBS2ReceiverSoCExample\soc_prj\hdlcoder\DVBS2\hdlsrc\soc_dvbs2_fpga\dvbs2_ip_src_FilterTapSystolicPreAddWvlIn_block1.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: dvbs2_ip_src_FilterTapSystolicPreAddWvlIn_block1
-- Source Path: soc_dvbs2_fpga/DVBS2/DVBS2 TxRx/Prepare Inputs/Discrete FIR Filter HDL Optimized1/Filter/subFilter/FilterTapSystolicPreAddWvlIn
-- Hierarchy Level: 6
-- Model version: 9.0
-- 
-- -------------------------------------------------------------
...
ENTITY dvbs2_ip_src_FilterTapSystolicPreAddWvlIn_block1 IS
...
END dvbs2_ip_src_FilterTapSystolicPreAddWvlIn_block1;


ARCHITECTURE rtl OF dvbs2_ip_src_FilterTapSystolicPreAddWvlIn_block1 IS

  -- Signals
  SIGNAL dinReg2_0_re_signed              : signed(15 DOWNTO 0);  -- sfix16_En14
  SIGNAL dinPreAdd_signed                 : signed(15 DOWNTO 0);  -- sfix16_En14
  SIGNAL coefIn_0_signed                  : signed(15 DOWNTO 0);  -- sfix16_En18
  ...
  SIGNAL fTap_coef_reg1_next              : signed(15 DOWNTO 0);  -- sfix16_En18
  SIGNAL fTap_coef_reg2_next              : signed(15 DOWNTO 0);  -- sfix16_En18
