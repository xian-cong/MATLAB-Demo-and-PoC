-- -------------------------------------------------------------
-- 
-- File Name: C:\demo\DVBS2ReceiverSoCExample\soc_prj\hdlcoder\DVBS2\hdlsrc\soc_dvbs2_fpga\dvbs2_ip_src_subFilter_block7.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: dvbs2_ip_src_subFilter_block7
-- Source Path: soc_dvbs2_fpga/DVBS2/Vector Interpolation/FIR Interpolator/FIRFilter1/Filter/subFilter
-- Hierarchy Level: 5
-- Model version: 9.0
-- 
-- -------------------------------------------------------------
...
ENTITY dvbs2_ip_src_subFilter_block7 IS
  PORT( clk                               :   IN    std_logic;
        reset                             :   IN    std_logic;
        enb                               :   IN    std_logic;
        dinReg2_0_re                      :   IN    std_logic_vector(15 DOWNTO 0);  -- sfix16
        coefIn                            :   IN    vector_of_std_logic_vector16(0 TO 31);  -- sfix16_En14 [32]
        dinRegVld                         :   IN    std_logic;
        syncReset                         :   IN    std_logic;
        dout_1_re                         :   OUT   std_logic_vector(15 DOWNTO 0);  -- sfix16
        doutVld                           :   OUT   std_logic
        );
END dvbs2_ip_src_subFilter_block7;


ARCHITECTURE rtl OF dvbs2_ip_src_subFilter_block7 IS

  -- Component Declarations
  COMPONENT dvbs2_ip_src_FilterTapSystolicWvldInC0_block
    PORT( clk                             :   IN    std_logic;
          enb                             :   IN    std_logic;
          dinReg2_0_re                    :   IN    std_logic_vector(15 DOWNTO 0);  -- sfix16
  ...
  COMPONENT dvbs2_ip_src_FilterTapSystolicWvldin_block3
    PORT( clk                             :   IN    std_logic;
          enb                             :   IN    std_logic;
          dinReg2_0_re                    :   IN    std_logic_vector(15 DOWNTO 0);  -- sfix16
  ...
  FOR ALL : dvbs2_ip_src_FilterTapSystolicWvldInC0_block
    USE ENTITY work.dvbs2_ip_src_FilterTapSystolicWvldInC0_block(rtl);

  FOR ALL : dvbs2_ip_src_FilterTapSystolicWvldin_block3
    USE ENTITY work.dvbs2_ip_src_FilterTapSystolicWvldin_block3(rtl);
...
BEGIN
  u_FilterTap_1 : dvbs2_ip_src_FilterTapSystolicWvldInC0_block
    PORT MAP( clk => clk,
              enb => enb,
  ...
  u_FilterTap_2 : dvbs2_ip_src_FilterTapSystolicWvldInC0_block
    PORT MAP( clk => clk,
              enb => enb,
  ...
  u_FilterTap_3 : dvbs2_ip_src_FilterTapSystolicWvldInC0_block
    PORT MAP( clk => clk,
              enb => enb,
  ...
  u_FilterTap_4 : dvbs2_ip_src_FilterTapSystolicWvldInC0_block
    PORT MAP( clk => clk,
              enb => enb,
  ...
  u_FilterTap_5 : dvbs2_ip_src_FilterTapSystolicWvldInC0_block
    PORT MAP( clk => clk,
              enb => enb,
  ...
  u_FilterTap_6 : dvbs2_ip_src_FilterTapSystolicWvldInC0_block
    PORT MAP( clk => clk,
              enb => enb,
  ...
  u_FilterTap_7 : dvbs2_ip_src_FilterTapSystolicWvldInC0_block
    PORT MAP( clk => clk,
              enb => enb,
  ...
  u_FilterTap_8 : dvbs2_ip_src_FilterTapSystolicWvldInC0_block
    PORT MAP( clk => clk,
              enb => enb,
  ...
  u_FilterTap_9 : dvbs2_ip_src_FilterTapSystolicWvldInC0_block
    PORT MAP( clk => clk,
              enb => enb,
  ...
  u_FilterTap_10 : dvbs2_ip_src_FilterTapSystolicWvldInC0_block
    PORT MAP( clk => clk,
              enb => enb,
  ...
  u_FilterTap_11 : dvbs2_ip_src_FilterTapSystolicWvldInC0_block
    PORT MAP( clk => clk,
              enb => enb,
  ...
  u_FilterTap_12 : dvbs2_ip_src_FilterTapSystolicWvldInC0_block
    PORT MAP( clk => clk,
              enb => enb,
  ...
  u_FilterTap_13 : dvbs2_ip_src_FilterTapSystolicWvldInC0_block
    PORT MAP( clk => clk,
              enb => enb,
  ...
  u_FilterTap_14 : dvbs2_ip_src_FilterTapSystolicWvldInC0_block
    PORT MAP( clk => clk,
              enb => enb,
  ...
  u_FilterTap_15 : dvbs2_ip_src_FilterTapSystolicWvldInC0_block
    PORT MAP( clk => clk,
              enb => enb,
  ...
  u_FilterTap_16 : dvbs2_ip_src_FilterTapSystolicWvldInC0_block
    PORT MAP( clk => clk,
              enb => enb,
  ...
  u_FilterTap_17 : dvbs2_ip_src_FilterTapSystolicWvldin_block3
    PORT MAP( clk => clk,
              enb => enb,
              dinReg2_0_re => dinDly2_15,  -- sfix16
              coefIn_0 => coefIn(16),  -- sfix16_En14
  ...
  u_FilterTap_18 : dvbs2_ip_src_FilterTapSystolicWvldInC0_block
    PORT MAP( clk => clk,
              enb => enb,
              dinReg2_0_re => dinDly2_16,  -- sfix16
              addin => tapout_16,  -- sfix48_En14
              dinRegVld => dinRegVld,
              syncReset => syncReset,
              dinDly2 => dinDly2_17,  -- sfix16
              tapout => tapout_17  -- sfix48_En14
              );

  u_FilterTap_19 : dvbs2_ip_src_FilterTapSystolicWvldInC0_block
    PORT MAP( clk => clk,
              enb => enb,
              dinReg2_0_re => dinDly2_17,  -- sfix16
              addin => tapout_17,  -- sfix48_En14
              dinRegVld => dinRegVld,
              syncReset => syncReset,
              dinDly2 => dinDly2_18,  -- sfix16
              tapout => tapout_18  -- sfix48_En14
              );

  u_FilterTap_20 : dvbs2_ip_src_FilterTapSystolicWvldInC0_block
    PORT MAP( clk => clk,
              enb => enb,
              dinReg2_0_re => dinDly2_18,  -- sfix16
              addin => tapout_18,  -- sfix48_En14
              dinRegVld => dinRegVld,
              syncReset => syncReset,
              dinDly2 => dinDly2_19,  -- sfix16
              tapout => tapout_19  -- sfix48_En14
              );

  u_FilterTap_21 : dvbs2_ip_src_FilterTapSystolicWvldInC0_block
    PORT MAP( clk => clk,
              enb => enb,
              dinReg2_0_re => dinDly2_19,  -- sfix16
              addin => tapout_19,  -- sfix48_En14
              dinRegVld => dinRegVld,
              syncReset => syncReset,
              dinDly2 => dinDly2_20,  -- sfix16
              tapout => tapout_20  -- sfix48_En14
              );

  u_FilterTap_22 : dvbs2_ip_src_FilterTapSystolicWvldInC0_block
    PORT MAP( clk => clk,
              enb => enb,
              dinReg2_0_re => dinDly2_20,  -- sfix16
              addin => tapout_20,  -- sfix48_En14
              dinRegVld => dinRegVld,
              syncReset => syncReset,
              dinDly2 => dinDly2_21,  -- sfix16
              tapout => tapout_21  -- sfix48_En14
              );

  u_FilterTap_23 : dvbs2_ip_src_FilterTapSystolicWvldInC0_block
    PORT MAP( clk => clk,
              enb => enb,
              dinReg2_0_re => dinDly2_21,  -- sfix16
              addin => tapout_21,  -- sfix48_En14
              dinRegVld => dinRegVld,
              syncReset => syncReset,
              dinDly2 => dinDly2_22,  -- sfix16
              tapout => tapout_22  -- sfix48_En14
              );

  u_FilterTap_24 : dvbs2_ip_src_FilterTapSystolicWvldInC0_block
    PORT MAP( clk => clk,
              enb => enb,
              dinReg2_0_re => dinDly2_22,  -- sfix16
              addin => tapout_22,  -- sfix48_En14
              dinRegVld => dinRegVld,
              syncReset => syncReset,
              dinDly2 => dinDly2_23,  -- sfix16
              tapout => tapout_23  -- sfix48_En14
              );

  u_FilterTap_25 : dvbs2_ip_src_FilterTapSystolicWvldInC0_block
    PORT MAP( clk => clk,
              enb => enb,
              dinReg2_0_re => dinDly2_23,  -- sfix16
              addin => tapout_23,  -- sfix48_En14
              dinRegVld => dinRegVld,
              syncReset => syncReset,
              dinDly2 => dinDly2_24,  -- sfix16
              tapout => tapout_24  -- sfix48_En14
              );

  u_FilterTap_26 : dvbs2_ip_src_FilterTapSystolicWvldInC0_block
    PORT MAP( clk => clk,
              enb => enb,
              dinReg2_0_re => dinDly2_24,  -- sfix16
              addin => tapout_24,  -- sfix48_En14
              dinRegVld => dinRegVld,
              syncReset => syncReset,
              dinDly2 => dinDly2_25,  -- sfix16
              tapout => tapout_25  -- sfix48_En14
              );

  u_FilterTap_27 : dvbs2_ip_src_FilterTapSystolicWvldInC0_block
    PORT MAP( clk => clk,
              enb => enb,
              dinReg2_0_re => dinDly2_25,  -- sfix16
              addin => tapout_25,  -- sfix48_En14
              dinRegVld => dinRegVld,
              syncReset => syncReset,
              dinDly2 => dinDly2_26,  -- sfix16
              tapout => tapout_26  -- sfix48_En14
              );

  u_FilterTap_28 : dvbs2_ip_src_FilterTapSystolicWvldInC0_block
    PORT MAP( clk => clk,
              enb => enb,
              dinReg2_0_re => dinDly2_26,  -- sfix16
              addin => tapout_26,  -- sfix48_En14
              dinRegVld => dinRegVld,
              syncReset => syncReset,
              dinDly2 => dinDly2_27,  -- sfix16
              tapout => tapout_27  -- sfix48_En14
              );

  u_FilterTap_29 : dvbs2_ip_src_FilterTapSystolicWvldInC0_block
    PORT MAP( clk => clk,
              enb => enb,
              dinReg2_0_re => dinDly2_27,  -- sfix16
              addin => tapout_27,  -- sfix48_En14
              dinRegVld => dinRegVld,
              syncReset => syncReset,
              dinDly2 => dinDly2_28,  -- sfix16
              tapout => tapout_28  -- sfix48_En14
              );

  u_FilterTap_30 : dvbs2_ip_src_FilterTapSystolicWvldInC0_block
    PORT MAP( clk => clk,
              enb => enb,
              dinReg2_0_re => dinDly2_28,  -- sfix16
              addin => tapout_28,  -- sfix48_En14
              dinRegVld => dinRegVld,
              syncReset => syncReset,
              dinDly2 => dinDly2_29,  -- sfix16
              tapout => tapout_29  -- sfix48_En14
              );

  u_FilterTap_31 : dvbs2_ip_src_FilterTapSystolicWvldInC0_block
    PORT MAP( clk => clk,
              enb => enb,
              dinReg2_0_re => dinDly2_29,  -- sfix16
              addin => tapout_29,  -- sfix48_En14
              dinRegVld => dinRegVld,
              syncReset => syncReset,
              dinDly2 => dinDly2_30,  -- sfix16
              tapout => tapout_30  -- sfix48_En14
              );

  u_FilterTap_32 : dvbs2_ip_src_FilterTapSystolicWvldInC0_block
    PORT MAP( clk => clk,
              enb => enb,
              dinReg2_0_re => dinDly2_30,  -- sfix16
              addin => tapout_30,  -- sfix48_En14
              dinRegVld => dinRegVld,
              syncReset => syncReset,
              dinDly2 => dinDly2deadOut,  -- sfix16
              tapout => tapout_31  -- sfix48_En14
              );
