-- -------------------------------------------------------------
-- 
-- File Name: C:\demo\DVBS2ReceiverSoCExample\soc_prj\hdlcoder\DVBS2\hdlsrc\soc_dvbs2_fpga\dvbs2_ip_src_subFilter_block9.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: dvbs2_ip_src_subFilter_block9
-- Source Path: soc_dvbs2_fpga/DVBS2/Vector Interpolation/FIR Interpolator/FIRFilter3/Filter/subFilter
-- Hierarchy Level: 5
-- Model version: 9.0
-- 
-- -------------------------------------------------------------
...
ENTITY dvbs2_ip_src_subFilter_block9 IS
...
END dvbs2_ip_src_subFilter_block9;


ARCHITECTURE rtl OF dvbs2_ip_src_subFilter_block9 IS

  -- Component Declarations
  COMPONENT dvbs2_ip_src_FilterTapSystolicPreAddWvlIn_block3
    PORT( clk                             :   IN    std_logic;
          enb                             :   IN    std_logic;
          dinReg2_0_re                    :   IN    std_logic_vector(15 DOWNTO 0);  -- sfix16
  ...
  FOR ALL : dvbs2_ip_src_FilterTapSystolicPreAddWvlIn_block3
    USE ENTITY work.dvbs2_ip_src_FilterTapSystolicPreAddWvlIn_block3(rtl);

  -- Signals
  SIGNAL intdelay_reg                     : std_logic_vector(19 DOWNTO 0);  -- ufix1 [20]
...
BEGIN
  u_FilterTap_1 : dvbs2_ip_src_FilterTapSystolicPreAddWvlIn_block3
    PORT MAP( clk => clk,
              enb => enb,
  ...
  u_FilterTap_2 : dvbs2_ip_src_FilterTapSystolicPreAddWvlIn_block3
    PORT MAP( clk => clk,
              enb => enb,
  ...
  u_FilterTap_3 : dvbs2_ip_src_FilterTapSystolicPreAddWvlIn_block3
    PORT MAP( clk => clk,
              enb => enb,
  ...
  u_FilterTap_4 : dvbs2_ip_src_FilterTapSystolicPreAddWvlIn_block3
    PORT MAP( clk => clk,
              enb => enb,
  ...
  u_FilterTap_5 : dvbs2_ip_src_FilterTapSystolicPreAddWvlIn_block3
    PORT MAP( clk => clk,
              enb => enb,
  ...
  u_FilterTap_6 : dvbs2_ip_src_FilterTapSystolicPreAddWvlIn_block3
    PORT MAP( clk => clk,
              enb => enb,
  ...
  u_FilterTap_7 : dvbs2_ip_src_FilterTapSystolicPreAddWvlIn_block3
    PORT MAP( clk => clk,
              enb => enb,
  ...
  u_FilterTap_8 : dvbs2_ip_src_FilterTapSystolicPreAddWvlIn_block3
    PORT MAP( clk => clk,
              enb => enb,
  ...
  u_FilterTap_9 : dvbs2_ip_src_FilterTapSystolicPreAddWvlIn_block3
    PORT MAP( clk => clk,
              enb => enb,
  ...
  u_FilterTap_10 : dvbs2_ip_src_FilterTapSystolicPreAddWvlIn_block3
    PORT MAP( clk => clk,
              enb => enb,
  ...
  u_FilterTap_11 : dvbs2_ip_src_FilterTapSystolicPreAddWvlIn_block3
    PORT MAP( clk => clk,
              enb => enb,
  ...
  u_FilterTap_12 : dvbs2_ip_src_FilterTapSystolicPreAddWvlIn_block3
    PORT MAP( clk => clk,
              enb => enb,
  ...
  u_FilterTap_13 : dvbs2_ip_src_FilterTapSystolicPreAddWvlIn_block3
    PORT MAP( clk => clk,
              enb => enb,
  ...
  u_FilterTap_14 : dvbs2_ip_src_FilterTapSystolicPreAddWvlIn_block3
    PORT MAP( clk => clk,
              enb => enb,
  ...
  u_FilterTap_15 : dvbs2_ip_src_FilterTapSystolicPreAddWvlIn_block3
    PORT MAP( clk => clk,
              enb => enb,
  ...
  u_FilterTap_16 : dvbs2_ip_src_FilterTapSystolicPreAddWvlIn_block3
    PORT MAP( clk => clk,
              enb => enb,
    ...
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb = '1' THEN
        ...
        ELSIF dinRegVld = '1' THEN
          ...
          intdelay_reg(19 DOWNTO 1) <= intdelay_reg(18 DOWNTO 0);
        END IF;
      END IF;
    END IF;
