-- -------------------------------------------------------------
-- 
-- File Name: C:\demo\DVBS2ReceiverSoCExample\soc_prj\hdlcoder\DVBS2\hdlsrc\soc_dvbs2_fpga\dvbs2_ip_src_NCO_HDL_Optimized_block2.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: dvbs2_ip_src_NCO_HDL_Optimized_block2
...
ENTITY dvbs2_ip_src_NCO_HDL_Optimized_block2 IS
...
END dvbs2_ip_src_NCO_HDL_Optimized_block2;


ARCHITECTURE rtl OF dvbs2_ip_src_NCO_HDL_Optimized_block2 IS

  -- Component Declarations
  COMPONENT dvbs2_ip_src_WaveformGen_block3
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_8_0                       :   IN    std_logic;
  ...
  FOR ALL : dvbs2_ip_src_WaveformGen_block3
    USE ENTITY work.dvbs2_ip_src_WaveformGen_block3(rtl);
...
BEGIN
  u_Wave_inst : dvbs2_ip_src_WaveformGen_block3
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_8_0 => enb_1_8_0,
