-- -------------------------------------------------------------
-- 
-- File Name: C:\demo\DVBS2ReceiverSoCExample\soc_prj\hdlcoder\DVBS2\hdlsrc\soc_dvbs2_fpga\dvbs2_ip_src_CRCGenControl_block.vhd
...
ENTITY dvbs2_ip_src_CRCGenControl_block IS
...
END dvbs2_ip_src_CRCGenControl_block;


ARCHITECTURE rtl OF dvbs2_ip_src_CRCGenControl_block IS

  -- Signals
  SIGNAL deofin                           : std_logic;  -- ufix1
  SIGNAL cnt3out                          : unsigned(2 DOWNTO 0);  -- ufix3
  ...
  SIGNAL cnt2fstout                       : unsigned(2 DOWNTO 0);  -- ufix3
  ...
  SIGNAL sof_delay_register_reg           : std_logic_vector(7 DOWNTO 0);  -- ufix1 [8]
  ...
  SIGNAL cnt5out                          : unsigned(2 DOWNTO 0);  -- ufix3
  SIGNAL cnt4out                          : unsigned(2 DOWNTO 0);  -- ufix3
  ...
  SIGNAL tvalidout_delay_register_reg     : std_logic_vector(7 DOWNTO 0);  -- ufix1 [8]
...
BEGIN
  ...
  processzero_short <= '1' WHEN cnt3out < to_unsigned(16#7#, 3) ELSE
      '0';
  ...
  cnt3enb <= '1' WHEN cnt2out >= to_unsigned(16#1#, 3) ELSE
      '0';
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        cnt3out <= to_unsigned(16#0#, 3);
      ELSIF enb = '1' THEN
        IF cnt2rst = '1' THEN 
          cnt3out <= to_unsigned(16#0#, 3);
        ELSIF cnt3enb = '1' THEN 
          cnt3out <= cnt3out + to_unsigned(16#1#, 3);
        END IF;
      END IF;
    END IF;
  ...
  cnt2rst <= '1' WHEN cnt3out = to_unsigned(16#7#, 3) ELSE
      '0';
    ...
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb = '1' THEN
        ...
        ELSIF cnt2enb = '1' THEN 
          IF cnt2out = to_unsigned(16#1#, 3) THEN 
            cnt2out <= to_unsigned(16#0#, 3);
          ELSE 
            cnt2out <= cnt2out + to_unsigned(16#7#, 3);
          END IF;
        END IF;
      END IF;
    END IF;
  ...
  compare_cmpOut <= '1' WHEN cnt2out = to_unsigned(16#0#, 3) ELSE
      '0';

  cnt2fstout <= '0' & '0' & compare_cmpOut;

  
  cnt2fstout_is_not0 <= '1' WHEN cnt2fstout /= to_unsigned(16#0#, 3) ELSE
      '0';
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb = '1' THEN
        ...
        sof_delay_register_reg(7 DOWNTO 1) <= sof_delay_register_reg(6 DOWNTO 0);
      END IF;
    END IF;
  END PROCESS sof_delay_register_process;

  startOut <= sof_delay_register_reg(7);
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        cnt5out <= to_unsigned(16#0#, 3);
      ELSIF enb = '1' THEN
        IF cnt4rst = '1' THEN 
          cnt5out <= to_unsigned(16#0#, 3);
        ELSIF cnt5enb = '1' THEN 
          cnt5out <= cnt5out + to_unsigned(16#1#, 3);
        END IF;
      END IF;
    END IF;
  ...
  cnt4rst <= '1' WHEN cnt5out = to_unsigned(16#7#, 3) ELSE
      '0';
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        cnt4out <= to_unsigned(16#0#, 3);
      ELSIF enb = '1' THEN
        IF cnt4rst = '1' THEN 
          cnt4out <= to_unsigned(16#0#, 3);
        ELSIF cnt2rst = '1' THEN 
          cnt4out <= cnt4out + to_unsigned(16#1#, 3);
        END IF;
      END IF;
    END IF;
  ...
  cnt5enb <= '1' WHEN cnt4out >= to_unsigned(16#1#, 3) ELSE
      '0';
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb = '1' THEN
        ...
        tvalidout_delay_register_reg(7 DOWNTO 1) <= tvalidout_delay_register_reg(6 DOWNTO 0);
      END IF;
    END IF;
  END PROCESS tvalidout_delay_register_process;

  dvalidout <= tvalidout_delay_register_reg(7);
