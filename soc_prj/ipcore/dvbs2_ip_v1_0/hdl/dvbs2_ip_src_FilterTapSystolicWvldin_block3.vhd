-- -------------------------------------------------------------
-- 
-- File Name: C:\demo\DVBS2ReceiverSoCExample\soc_prj\hdlcoder\DVBS2\hdlsrc\soc_dvbs2_fpga\dvbs2_ip_src_FilterTapSystolicWvldin_block3.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: dvbs2_ip_src_FilterTapSystolicWvldin_block3
-- Source Path: soc_dvbs2_fpga/DVBS2/Vector Interpolation/FIR Interpolator/FIRFilter1/Filter/subFilter/FilterTapSystolicWvldin
-- Hierarchy Level: 6
-- Model version: 9.0
-- 
-- -------------------------------------------------------------
...
ENTITY dvbs2_ip_src_FilterTapSystolicWvldin_block3 IS
...
END dvbs2_ip_src_FilterTapSystolicWvldin_block3;


ARCHITECTURE rtl OF dvbs2_ip_src_FilterTapSystolicWvldin_block3 IS

  -- Signals
  SIGNAL dinReg2_0_re_signed              : signed(15 DOWNTO 0);  -- sfix16
  SIGNAL coefIn_0_signed                  : signed(15 DOWNTO 0);  -- sfix16_En14
  SIGNAL addin_signed                     : signed(47 DOWNTO 0);  -- sfix48_En14
  ...
  SIGNAL fTap_mult_reg_next               : signed(31 DOWNTO 0);  -- sfix32_En14
  SIGNAL fTap_addout_reg_next             : signed(47 DOWNTO 0);  -- sfix48_En14
  SIGNAL dinDly2_tmp                      : signed(15 DOWNTO 0);  -- sfix16
  SIGNAL tapout_tmp                       : signed(47 DOWNTO 0);  -- sfix48_En14
