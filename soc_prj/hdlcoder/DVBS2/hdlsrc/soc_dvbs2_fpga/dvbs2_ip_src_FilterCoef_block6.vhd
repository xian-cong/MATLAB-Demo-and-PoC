-- -------------------------------------------------------------
-- 
-- File Name: C:\demo\DVBS2ReceiverSoCExample\soc_prj\hdlcoder\DVBS2\hdlsrc\soc_dvbs2_fpga\dvbs2_ip_src_FilterCoef_block6.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: dvbs2_ip_src_FilterCoef_block6
...
ENTITY dvbs2_ip_src_FilterCoef_block6 IS
  PORT( CoefOut                           :   OUT   vector_of_std_logic_vector16(0 TO 23)  -- sfix16_En16 [24]
        );
END dvbs2_ip_src_FilterCoef_block6;


ARCHITECTURE rtl OF dvbs2_ip_src_FilterCoef_block6 IS
...
BEGIN
  ...
  -- CoefReg_13
  CoefData_12 <= to_signed(16#4000#, 16);
  ...
  -- CoefReg_17
  CoefData_16 <= to_signed(16#0000#, 16);
