-- -------------------------------------------------------------
-- 
-- File Name: C:\demo\DVBS2ReceiverSoCExample\soc_prj\hdlcoder\DVBS2\hdlsrc\soc_dvbs2_fpga\dvbs2_ip_src_Sine_HDL_Optimized2.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: dvbs2_ip_src_Sine_HDL_Optimized2
...
ENTITY dvbs2_ip_src_Sine_HDL_Optimized2 IS
...
END dvbs2_ip_src_Sine_HDL_Optimized2;


ARCHITECTURE rtl OF dvbs2_ip_src_Sine_HDL_Optimized2 IS
  ...
  SIGNAL LTEp25_cast                      : signed(16 DOWNTO 0);  -- sfix17_En16
  ...
  SIGNAL p50mA_out1_dtc                   : unsigned(11 DOWNTO 0);  -- ufix12_En12
  SIGNAL QuadHandle1_out1_dtc             : unsigned(11 DOWNTO 0);  -- ufix12_En12
  SIGNAL QuadHandle2_out1                 : unsigned(11 DOWNTO 0);  -- ufix12_En12
  SIGNAL CastU16En2_out1                  : unsigned(11 DOWNTO 0);  -- ufix12
  SIGNAL CastU16En4_out1                  : unsigned(12 DOWNTO 0);  -- ufix13
  SIGNAL CastU16En3_out1                  : unsigned(11 DOWNTO 0);  -- ufix12
  ...
  SIGNAL Sine                             : signed(15 DOWNTO 0);  -- sfix16_En15
  SIGNAL Sine_1                           : signed(15 DOWNTO 0);  -- sfix16_En15
...
BEGIN
  ...
  Amp50_sub_cast <= signed(resize(insig_out1 & '0' & '0' & '0' & '0', 17));
  Amp50_sub_cast_1 <= signed(resize(Point50_out1, 17));
  Amp50_out1 <= Amp50_sub_cast - Amp50_sub_cast_1;

  insig_out1_dtc <= signed(resize(insig_out1 & '0' & '0' & '0' & '0', 17));
  ...
  LTEp25_cast <= signed(resize(Point25_out1, 17));
  ...
  p50mA_out1_dtc <= unsigned(p50mA_out1(15 DOWNTO 4));

  QuadHandle1_out1_dtc <= unsigned(QuadHandle1_out1(15 DOWNTO 4));
  ...
  CastU16En4_out1 <= resize(CastU16En2_out1, 13);

  
  CastU16En3_out1 <= "111111111111" WHEN CastU16En4_out1(12) /= '0' ELSE
      CastU16En4_out1(11 DOWNTO 0);

  -- saturation block maybe optimized away
  -- if the NumDataPoints is a power of 2
  
  Saturation_out1 <= to_unsigned(16#3FF#, 12) WHEN CastU16En3_out1 > to_unsigned(16#3FF#, 12) ELSE
      CastU16En3_out1;
