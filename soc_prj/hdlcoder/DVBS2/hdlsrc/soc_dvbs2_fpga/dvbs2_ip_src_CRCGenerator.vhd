-- -------------------------------------------------------------
-- 
-- File Name: C:\demo\DVBS2ReceiverSoCExample\soc_prj\hdlcoder\DVBS2\hdlsrc\soc_dvbs2_fpga\dvbs2_ip_src_CRCGenerator.vhd
...
ENTITY dvbs2_ip_src_CRCGenerator IS
...
END dvbs2_ip_src_CRCGenerator;


ARCHITECTURE rtl OF dvbs2_ip_src_CRCGenerator IS

  -- Component Declarations
  COMPONENT dvbs2_ip_src_CRCGenControl
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          startIn                         :   IN    std_logic;  -- ufix1
  ...
  COMPONENT dvbs2_ip_src_CRCGenCompute
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : dvbs2_ip_src_CRCGenControl
    USE ENTITY work.dvbs2_ip_src_CRCGenControl(rtl);

  FOR ALL : dvbs2_ip_src_CRCGenCompute
    USE ENTITY work.dvbs2_ip_src_CRCGenCompute(rtl);
...
BEGIN
  u_Controlsignal_inst : dvbs2_ip_src_CRCGenControl
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_ComputeCRC_inst : dvbs2_ip_src_CRCGenCompute
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
