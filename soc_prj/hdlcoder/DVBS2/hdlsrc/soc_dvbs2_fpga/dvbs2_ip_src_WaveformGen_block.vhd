-- -------------------------------------------------------------
-- 
-- File Name: C:\demo\DVBS2ReceiverSoCExample\soc_prj\hdlcoder\DVBS2\hdlsrc\soc_dvbs2_fpga\dvbs2_ip_src_WaveformGen_block.vhd
...
ENTITY dvbs2_ip_src_WaveformGen_block IS
...
END dvbs2_ip_src_WaveformGen_block;


ARCHITECTURE rtl OF dvbs2_ip_src_WaveformGen_block IS

  -- Component Declarations
  COMPONENT dvbs2_ip_src_CosLookUpTableGen_block
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_32_0                      :   IN    std_logic;
  ...
  COMPONENT dvbs2_ip_src_SinLookUpTableGen_block
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_32_0                      :   IN    std_logic;
          lutaddr                         :   IN    std_logic_vector(10 DOWNTO 0);  -- ufix11
  ...
  FOR ALL : dvbs2_ip_src_CosLookUpTableGen_block
    USE ENTITY work.dvbs2_ip_src_CosLookUpTableGen_block(rtl);

  FOR ALL : dvbs2_ip_src_SinLookUpTableGen_block
    USE ENTITY work.dvbs2_ip_src_SinLookUpTableGen_block(rtl);
...
BEGIN
  u_Cos_Wave_inst : dvbs2_ip_src_CosLookUpTableGen_block
    PORT MAP( clk => clk,
              reset => reset,
  ...
  u_Sin_Wave_inst : dvbs2_ip_src_SinLookUpTableGen_block
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_32_0 => enb_1_32_0,
              lutaddr => std_logic_vector(lutaddrO),  -- ufix11
