-- -------------------------------------------------------------
-- 
-- File Name: C:\demo\DVBS2ReceiverSoCExample\soc_prj\hdlcoder\DVBS2\hdlsrc\soc_dvbs2_fpga\dvbs2_ip_src_WaveformGen_block3.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: dvbs2_ip_src_WaveformGen_block3
...
-- Synthesis/NCO HDL Optimized/WaveformGe
-- Hierarchy Level: 9
-- Model version: 9.0
-- 
...
ENTITY dvbs2_ip_src_WaveformGen_block3 IS
...
END dvbs2_ip_src_WaveformGen_block3;


ARCHITECTURE rtl OF dvbs2_ip_src_WaveformGen_block3 IS

  -- Component Declarations
  COMPONENT dvbs2_ip_src_CosLookUpTableGen_block3
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_8_0                       :   IN    std_logic;
  ...
  COMPONENT dvbs2_ip_src_SinLookUpTableGen_block3
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_8_0                       :   IN    std_logic;
          lutaddr                         :   IN    std_logic_vector(10 DOWNTO 0);  -- ufix11
  ...
  FOR ALL : dvbs2_ip_src_CosLookUpTableGen_block3
    USE ENTITY work.dvbs2_ip_src_CosLookUpTableGen_block3(rtl);

  FOR ALL : dvbs2_ip_src_SinLookUpTableGen_block3
    USE ENTITY work.dvbs2_ip_src_SinLookUpTableGen_block3(rtl);
...
BEGIN
  u_Cos_Wave_inst : dvbs2_ip_src_CosLookUpTableGen_block3
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_8_0 => enb_1_8_0,
  ...
  u_Sin_Wave_inst : dvbs2_ip_src_SinLookUpTableGen_block3
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_8_0 => enb_1_8_0,
              lutaddr => std_logic_vector(lutaddrO),  -- ufix11
