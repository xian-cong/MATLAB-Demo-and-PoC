-- -------------------------------------------------------------
-- 
-- File Name: C:\demo\DVBS2ReceiverSoCExample\soc_prj\hdlcoder\DVBS2\hdlsrc\soc_dvbs2_fpga\dvbs2_ip_src_Filter_block3.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: dvbs2_ip_src_Filter_block3
-- Source Path: soc_dvbs2_fpga/DVBS2/Vector Interpolation/FIR Interpolator/FIRFilter1/Filter
-- Hierarchy Level: 4
-- Model version: 9.0
-- 
-- -------------------------------------------------------------
...
ENTITY dvbs2_ip_src_Filter_block3 IS
...
END dvbs2_ip_src_Filter_block3;


ARCHITECTURE rtl OF dvbs2_ip_src_Filter_block3 IS

  -- Component Declarations
  COMPONENT dvbs2_ip_src_FilterCoef_block7
    PORT( CoefOut                         :   OUT   vector_of_std_logic_vector16(0 TO 31)  -- sfix16_En14 [32]
          );
  END COMPONENT;

  COMPONENT dvbs2_ip_src_subFilter_block7
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : dvbs2_ip_src_FilterCoef_block7
    USE ENTITY work.dvbs2_ip_src_FilterCoef_block7(rtl);

  FOR ALL : dvbs2_ip_src_subFilter_block7
    USE ENTITY work.dvbs2_ip_src_subFilter_block7(rtl);
...
BEGIN
  u_CoefTable_1 : dvbs2_ip_src_FilterCoef_block7
    PORT MAP( CoefOut => CoefOut  -- sfix16_En14 [32]
              );

  u_subFilter_1_re : dvbs2_ip_src_subFilter_block7
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              dinReg2_0_re => std_logic_vector(dinReg2_0_re),  -- sfix16
              coefIn => CoefOut,  -- sfix16_En14 [32]
  ...
  u_subFilter_1_im : dvbs2_ip_src_subFilter_block7
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
