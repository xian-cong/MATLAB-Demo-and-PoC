-- -------------------------------------------------------------
-- 
-- File Name: C:\demo\DVBS2ReceiverSoCExample\soc_prj\hdlcoder\DVBS2\hdlsrc\soc_dvbs2_fpga\dvbs2_ip_src_WaveformGen_block1.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: dvbs2_ip_src_WaveformGen_block1
-- Source Path: soc_dvbs2_fpga/DVBS2/DVBS2 TxRx/DVB-S2 HDL Receiver/Synchronizer and PL Header Decoder/Time Frequency 
-- and Coarse Phase Synchronizer/Coarse Phase Synchronizer/Unwrapping algorithm/NCO HDL Optimized/WaveformGe
-- Hierarchy Level: 8
-- Model version: 9.0
-- 
...
ENTITY dvbs2_ip_src_WaveformGen_block1 IS
...
END dvbs2_ip_src_WaveformGen_block1;


ARCHITECTURE rtl OF dvbs2_ip_src_WaveformGen_block1 IS

  -- Component Declarations
  COMPONENT dvbs2_ip_src_CosLookUpTableGen_block1
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_32_0                      :   IN    std_logic;
  ...
  COMPONENT dvbs2_ip_src_SinLookUpTableGen_block1
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_32_0                      :   IN    std_logic;
          lutaddr                         :   IN    std_logic_vector(10 DOWNTO 0);  -- ufix11
  ...
  FOR ALL : dvbs2_ip_src_CosLookUpTableGen_block1
    USE ENTITY work.dvbs2_ip_src_CosLookUpTableGen_block1(rtl);

  FOR ALL : dvbs2_ip_src_SinLookUpTableGen_block1
    USE ENTITY work.dvbs2_ip_src_SinLookUpTableGen_block1(rtl);
...
BEGIN
  u_Cos_Wave_inst : dvbs2_ip_src_CosLookUpTableGen_block1
    PORT MAP( clk => clk,
              reset => reset,
  ...
  u_Sin_Wave_inst : dvbs2_ip_src_SinLookUpTableGen_block1
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_32_0 => enb_1_32_0,
              lutaddr => std_logic_vector(lutaddrO),  -- ufix11
