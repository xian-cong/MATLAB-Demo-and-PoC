-- -------------------------------------------------------------
-- 
-- File Name: C:\demo\DVBS2ReceiverSoCExample\soc_prj\hdlcoder\DVBS2\hdlsrc\soc_dvbs2_fpga\dvbs2_ip_src_NCO_HDL_Optimized_block.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: dvbs2_ip_src_NCO_HDL_Optimized_block
-- Source Path: soc_dvbs2_fpga/DVBS2/DVBS2 TxRx/DVB-S2 HDL Receiver/Synchronizer and PL Header Decoder/Time Frequency 
-- and Coarse Phase Synchronizer/Coarse Phase Synchronizer/Unwrapping algorithm/NCO HDL Optimize
-- Hierarchy Level: 7
-- Model version: 9.0
-- 
-- NCO
...
ENTITY dvbs2_ip_src_NCO_HDL_Optimized_block IS
...
END dvbs2_ip_src_NCO_HDL_Optimized_block;


ARCHITECTURE rtl OF dvbs2_ip_src_NCO_HDL_Optimized_block IS

  -- Component Declarations
  COMPONENT dvbs2_ip_src_WaveformGen_block1
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_32_0                      :   IN    std_logic;
  ...
  FOR ALL : dvbs2_ip_src_WaveformGen_block1
    USE ENTITY work.dvbs2_ip_src_WaveformGen_block1(rtl);
...
BEGIN
  u_Wave_inst : dvbs2_ip_src_WaveformGen_block1
    PORT MAP( clk => clk,
              reset => reset,
