-- -------------------------------------------------------------
-- 
-- File Name: C:\demo\DVBS2ReceiverSoCExample\soc_prj\hdlcoder\DVBS2\hdlsrc\soc_dvbs2_fpga\dvbs2_ip_src_Coarse_Phase_Corrector.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: dvbs2_ip_src_Coarse_Phase_Corrector
-- Source Path: soc_dvbs2_fpga/DVBS2/DVBS2 TxRx/DVB-S2 HDL Receiver/Synchronizer and PL Header Decoder/Time Frequency 
-- and Coarse Phase Synchronizer/Coarse Phase Synchronizer/Coarse Phase Correcto
-- Hierarchy Level: 6
-- Model version: 9.0
-- 
-- -------------------------------------------------------------
...
ENTITY dvbs2_ip_src_Coarse_Phase_Corrector IS
...
END dvbs2_ip_src_Coarse_Phase_Corrector;


ARCHITECTURE rtl OF dvbs2_ip_src_Coarse_Phase_Corrector IS

  -- Component Declarations
  COMPONENT dvbs2_ip_src_HDL_CMA_core
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_32_0                      :   IN    std_logic;
  ...
  COMPONENT dvbs2_ip_src_Reciprocal
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_32_0                      :   IN    std_logic;
  ...
  FOR ALL : dvbs2_ip_src_HDL_CMA_core
    USE ENTITY work.dvbs2_ip_src_HDL_CMA_core(rtl);

  FOR ALL : dvbs2_ip_src_Reciprocal
    USE ENTITY work.dvbs2_ip_src_Reciprocal(rtl);

  -- Signals
  SIGNAL Constant_out1                    : std_logic;
  SIGNAL dataIn_re_signed                 : signed(17 DOWNTO 0);  -- sfix18_En13
  SIGNAL dataIn_im_signed                 : signed(17 DOWNTO 0);  -- sfix18_En13
  SIGNAL Delay_reg_re                     : vector_of_signed18(0 TO 14);  -- sfix18_En13 [15]
  SIGNAL Delay_reg_im                     : vector_of_signed18(0 TO 14);  -- sfix18_En13 [15]
  SIGNAL Delay_out1_re                    : signed(17 DOWNTO 0);  -- sfix18_En13
  SIGNAL Delay_out1_im                    : signed(17 DOWNTO 0);  -- sfix18_En13
  SIGNAL Delay8_reg_re                    : vector_of_signed18(0 TO 1) := (OTHERS => to_signed(16#00000#, 18));  -- sfix18_En13 [2]
  SIGNAL Delay8_reg_im                    : vector_of_signed18(0 TO 1) := (OTHERS => to_signed(16#00000#, 18));  -- sfix18_En13 [2]
  SIGNAL Delay8_out1_re                   : signed(17 DOWNTO 0);  -- sfix18_En13
  SIGNAL Delay8_out1_im                   : signed(17 DOWNTO 0);  -- sfix18_En13
  SIGNAL Delay11_reg_re                   : vector_of_signed18(0 TO 6) := (OTHERS => to_signed(16#00000#, 18));  -- sfix18_En13 [7]
  SIGNAL Delay11_reg_im                   : vector_of_signed18(0 TO 6) := (OTHERS => to_signed(16#00000#, 18));  -- sfix18_En13 [7]
  SIGNAL Delay11_out1_re                  : signed(17 DOWNTO 0);  -- sfix18_En13
  SIGNAL Delay11_out1_im                  : signed(17 DOWNTO 0);  -- sfix18_En13
  SIGNAL Delay36_reg_re                   : vector_of_signed18(0 TO 1) := (OTHERS => to_signed(16#00000#, 18));  -- sfix18_En13 [2]
  SIGNAL Delay36_reg_im                   : vector_of_signed18(0 TO 1) := (OTHERS => to_signed(16#00000#, 18));  -- sfix18_En13 [2]
  SIGNAL Delay36_out1_re                  : signed(17 DOWNTO 0);  -- sfix18_En13
  SIGNAL Delay36_out1_im                  : signed(17 DOWNTO 0);  -- sfix18_En13
  SIGNAL Delay38_reg_re                   : vector_of_signed18(0 TO 1) := (OTHERS => to_signed(16#00000#, 18));  -- sfix18_En13 [2]
  SIGNAL Delay38_reg_im                   : vector_of_signed18(0 TO 1) := (OTHERS => to_signed(16#00000#, 18));  -- sfix18_En13 [2]
  ...
  SIGNAL Delay41_reg_re                   : vector_of_signed18(0 TO 1) := (OTHERS => to_signed(16#00000#, 18));  -- sfix18_En13 [2]
  SIGNAL Delay41_reg_im                   : vector_of_signed18(0 TO 1) := (OTHERS => to_signed(16#00000#, 18));  -- sfix18_En13 [2]
  SIGNAL Delay41_out1_re                  : signed(17 DOWNTO 0);  -- sfix18_En13
  SIGNAL Delay41_out1_im                  : signed(17 DOWNTO 0);  -- sfix18_En13
  ...
  SIGNAL Product2_mul_temp                : signed(29 DOWNTO 0);  -- sfix30_En23
  SIGNAL Product2_sub_cast                : signed(17 DOWNTO 0);  -- sfix18_En13
  SIGNAL Product2_mul_temp_1              : signed(29 DOWNTO 0);  -- sfix30_En23
  SIGNAL Product2_sub_cast_1              : signed(17 DOWNTO 0);  -- sfix18_En13
  SIGNAL Product2_mul_temp_2              : signed(29 DOWNTO 0);  -- sfix30_En23
  SIGNAL Product2_add_cast                : signed(17 DOWNTO 0);  -- sfix18_En13
  SIGNAL Product2_mul_temp_3              : signed(29 DOWNTO 0);  -- sfix30_En23
  SIGNAL Product2_add_cast_1              : signed(17 DOWNTO 0);  -- sfix18_En13
  SIGNAL Product2_out1_re                 : signed(17 DOWNTO 0);  -- sfix18_En13
  SIGNAL Product2_out1_im                 : signed(17 DOWNTO 0);  -- sfix18_En13
  ...
  SIGNAL Complex_to_Magnitude_Angle_HDL_Optimized_out1 : std_logic_vector(12 DOWNTO 0);  -- ufix13
  SIGNAL Complex_to_Magnitude_Angle_HDL_Optimized_out1_signed : signed(12 DOWNTO 0);  -- sfix13_En10
  ...
  SIGNAL Product1_mul_temp                : signed(43 DOWNTO 0);  -- sfix44_En27
  SIGNAL Product1_mul_temp_1              : signed(43 DOWNTO 0);  -- sfix44_En27
  SIGNAL Product1_out1_re                 : signed(17 DOWNTO 0);  -- sfix18_En13
  SIGNAL Product1_out1_im                 : signed(17 DOWNTO 0);  -- sfix18_En13
  SIGNAL Delay39_reg_re                   : vector_of_signed18(0 TO 1) := (OTHERS => to_signed(16#00000#, 18));  -- sfix18_En13 [2]
  SIGNAL Delay39_reg_im                   : vector_of_signed18(0 TO 1) := (OTHERS => to_signed(16#00000#, 18));  -- sfix18_En13 [2]
  SIGNAL Delay39_out1_re                  : signed(17 DOWNTO 0);  -- sfix18_En13
  SIGNAL Delay39_out1_im                  : signed(17 DOWNTO 0);  -- sfix18_En13
  SIGNAL Multiport_Switch1_out1_re        : signed(17 DOWNTO 0);  -- sfix18_En13
  SIGNAL Multiport_Switch1_out1_im        : signed(17 DOWNTO 0);  -- sfix18_En13
...
BEGIN
  -- Set this value to zero to disable correction
  -- Let Z be the complex phase estimate and Xbar be the data and X be the corrected data.
  -- X = Xbar * conj(Z) * (1/abs(Z))

  u_Complex_to_Magnitude_Angle_HDL_Optimized : dvbs2_ip_src_HDL_CMA_core
    PORT MAP( clk => clk,
              reset => reset,
              ...
              magnitude => Complex_to_Magnitude_Angle_HDL_Optimized_out1  -- sfix13_En10
              );

  u_Reciprocal : dvbs2_ip_src_Reciprocal
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_32_0 => enb_1_32_0,
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb_1_32_0 = '1' THEN
        Delay10_reg(0) <= Complex_to_Magnitude_Angle_HDL_Optimized_out1_signed;
  ...
  Product1_out1_re <= Product1_mul_temp(31 DOWNTO 14);
  Product1_mul_temp_1 <= Delay15_out1_im * Delay17_out1;
  Product1_out1_im <= Product1_mul_temp_1(31 DOWNTO 14);
