-- -------------------------------------------------------------
-- 
-- File Name: C:\demo\DVBS2ReceiverSoCExample\soc_prj\hdlcoder\DVBS2\hdlsrc\soc_dvbs2_fpga\dvbs2_ip_src_NCO.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: dvbs2_ip_src_NCO
-- Source Path: soc_dvbs2_fpga/DVBS2/DVBS2 TxRx/Channel/NCO
-- Hierarchy Level: 3
-- Model version: 9.0
-- 
-- NCO
...
END dvbs2_ip_src_NCO;


ARCHITECTURE rtl OF dvbs2_ip_src_NCO IS

  -- Component Declarations
  COMPONENT dvbs2_ip_src_WaveformGen
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_8_0                       :   IN    std_logic;
  ...
  FOR ALL : dvbs2_ip_src_WaveformGen
    USE ENTITY work.dvbs2_ip_src_WaveformGen(rtl);
...
BEGIN
  u_Wave_inst : dvbs2_ip_src_WaveformGen
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_8_0 => enb_1_8_0,
