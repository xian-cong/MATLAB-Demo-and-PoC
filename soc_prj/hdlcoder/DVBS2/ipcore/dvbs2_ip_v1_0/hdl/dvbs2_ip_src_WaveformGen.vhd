-- -------------------------------------------------------------
-- 
-- File Name: C:\demo\DVBS2ReceiverSoCExample\soc_prj\hdlcoder\DVBS2\hdlsrc\soc_dvbs2_fpga\dvbs2_ip_src_WaveformGen.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: dvbs2_ip_src_WaveformGen
-- Source Path: soc_dvbs2_fpga/DVBS2/DVBS2 TxRx/Channel/NCO/WaveformGen
-- Hierarchy Level: 4
-- Model version: 9.0
-- 
...
ENTITY dvbs2_ip_src_WaveformGen IS
...
END dvbs2_ip_src_WaveformGen;


ARCHITECTURE rtl OF dvbs2_ip_src_WaveformGen IS

  -- Component Declarations
  COMPONENT dvbs2_ip_src_CosLookUpTableGen
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_8_0                       :   IN    std_logic;
  ...
  COMPONENT dvbs2_ip_src_SinLookUpTableGen
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_8_0                       :   IN    std_logic;
          lutaddr                         :   IN    std_logic_vector(10 DOWNTO 0);  -- ufix11
  ...
  FOR ALL : dvbs2_ip_src_CosLookUpTableGen
    USE ENTITY work.dvbs2_ip_src_CosLookUpTableGen(rtl);

  FOR ALL : dvbs2_ip_src_SinLookUpTableGen
    USE ENTITY work.dvbs2_ip_src_SinLookUpTableGen(rtl);
...
BEGIN
  u_Cos_Wave_inst : dvbs2_ip_src_CosLookUpTableGen
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_8_0 => enb_1_8_0,
  ...
  u_Sin_Wave_inst : dvbs2_ip_src_SinLookUpTableGen
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_8_0 => enb_1_8_0,
              lutaddr => std_logic_vector(lutaddrO),  -- ufix11
