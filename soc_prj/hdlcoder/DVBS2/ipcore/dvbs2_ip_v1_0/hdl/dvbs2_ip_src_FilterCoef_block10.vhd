-- -------------------------------------------------------------
-- 
-- File Name: C:\demo\DVBS2ReceiverSoCExample\soc_prj\hdlcoder\DVBS2\hdlsrc\soc_dvbs2_fpga\dvbs2_ip_src_FilterCoef_block10.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: dvbs2_ip_src_FilterCoef_block10
-- Source Path: soc_dvbs2_fpga/DVBS2/Vector Interpolation/FIR Interpolator/FIRFilter4/Filter/FilterCoef
-- Hierarchy Level: 5
-- Model version: 9.0
-- 
-- -------------------------------------------------------------
...
ENTITY dvbs2_ip_src_FilterCoef_block10 IS
  PORT( CoefOut                           :   OUT   vector_of_std_logic_vector16(0 TO 31)  -- sfix16_En15 [32]
        );
END dvbs2_ip_src_FilterCoef_block10;


ARCHITECTURE rtl OF dvbs2_ip_src_FilterCoef_block10 IS
