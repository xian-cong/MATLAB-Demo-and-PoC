-- -------------------------------------------------------------
-- 
-- File Name: C:\demo\DVBS2ReceiverSoCExample\soc_prj\hdlcoder\DVBS2\hdlsrc\soc_dvbs2_fpga\dvbs2_ip_src_TausURNG2.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: dvbs2_ip_src_TausURNG2
-- Source Path: soc_dvbs2_fpga/DVBS2/DVBS2 TxRx/Channel/AWGN Generator/Unit Variance Gaussian Noise/TausUniformRandGen/TausURNG2
-- Hierarchy Level: 6
-- Model version: 9.0
-- 
-- -------------------------------------------------------------
...
ENTITY dvbs2_ip_src_TausURNG2 IS
  PORT( clk                               :   IN    std_logic;
        reset                             :   IN    std_logic;
        enb_1_8_0                         :   IN    std_logic;
        b                                 :   OUT   std_logic_vector(31 DOWNTO 0)  -- uint32
        );
END dvbs2_ip_src_TausURNG2;


ARCHITECTURE rtl OF dvbs2_ip_src_TausURNG2 IS
