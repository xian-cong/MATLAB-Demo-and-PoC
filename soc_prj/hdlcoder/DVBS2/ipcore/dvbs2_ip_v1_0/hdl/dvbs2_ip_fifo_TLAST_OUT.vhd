-- -------------------------------------------------------------
-- 
-- File Name: C:\demo\DVBS2ReceiverSoCExample\soc_prj\hdlcoder\DVBS2\hdlsrc\soc_dvbs2_fpga\dvbs2_ip_fifo_TLAST_OUT.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: dvbs2_ip_fifo_TLAST_OUT
-- Source Path: dvbs2_ip/dvbs2_ip_axi4_stream_0_master/dvbs2_ip_fifo_TLAST_OUT
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY dvbs2_ip_fifo_TLAST_OUT IS
...
END dvbs2_ip_fifo_TLAST_OUT;


ARCHITECTURE rtl OF dvbs2_ip_fifo_TLAST_OUT IS

  -- Component Declarations
  COMPONENT dvbs2_ip_SimpleDualPortRAM_singlebit
  ...
  FOR ALL : dvbs2_ip_SimpleDualPortRAM_singlebit
    USE ENTITY work.dvbs2_ip_SimpleDualPortRAM_singlebit(rtl);
...
BEGIN
  ...
  u_dvbs2_ip_fifo_TLAST_OUT_classic_ram_singlebit : dvbs2_ip_SimpleDualPortRAM_singlebit
