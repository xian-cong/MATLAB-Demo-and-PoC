 ...
 *  -------------------------------------------------------------------------
 *
 * Created: Mon Jan 19 16:28:99 2026
 */

#define S_FUNCTION_LEVEL               2
#define S_FUNCTION_NAME                csv_reader
  ...
  if (ssGetSimMode(S) != SS_SIMMODE_SIZES_CALL_ONLY) {
    ...
    if (outUnitIdReg != INVALID_UNIT_ID) {
      ...
      ssSetLocalErrorStatus(S,
                            "Invalid Unit provided for output port y0 of S-Function csv_reader");
      return;
    }
