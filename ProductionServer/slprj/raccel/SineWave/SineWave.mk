###########################################################################
## Makefile generated for component 'SineWave'. 
## 
## Makefile     : SineWave.mk
## Generated on : Thu Jan 15 09:49:51 2026
## Final product: ./SineWave.exe
...
COMPILER_COMMAND_FILE     = SineWave_comp.rsp
CMD_FILE                  = SineWave.rsp
...
DEFINES_STANDARD = -DMODEL=SineWave -DNUMST=2 -DNCSTATES=0 -DHAVESTDIO
...
SRCS = $(START_DIR)/slprj/raccel/SineWave/SineWave.c $(START_DIR)/slprj/raccel/SineWave/SineWave_capi.c $(START_DIR)/slprj/raccel/SineWave/SineWave_data.c $(START_DIR)/slprj/raccel/SineWave/SineWave_tgtconn.c $(START_DIR)/slprj/raccel/SineWave/rt_nonfinite.c $(MATLAB_ROOT)/rtw/c/raccel/raccel_main.c $(MATLAB_ROOT)/rtw/c/raccel/raccel_sup.c $(MATLAB_ROOT)/rtw/c/raccel/raccel_mat.c $(MATLAB_ROOT)/simulink/include/simulink_solver_api.c $(MATLAB_ROOT)/rtw/c/src/rapid/raccel_utils.c $(MATLAB_ROOT)/rtw/c/src/rapid/slsa_sim_common_utils.c $(MATLAB_ROOT)/rtw/c/raccel/main.c $(MATLAB_ROOT)/rtw/c/src/ext_mode/common/ext_svr.c $(MATLAB_ROOT)/rtw/c/src/ext_mode/common/updown.c $(MATLAB_ROOT)/rtw/c/src/ext_mode/common/ext_work.c $(MATLAB_ROOT)/rtw/c/src/ext_mode/common/rtiostream_interface.c $(MATLAB_ROOT)/toolbox/coder/rtiostream/src/rtiostreamtcpip/rtiostream_tcpip.c $(MATLAB_ROOT)/toolbox/coder/rtiostream/src/utils/rtiostream_utils.c
...
OBJS = SineWave.obj SineWave_capi.obj SineWave_data.obj SineWave_tgtconn.obj rt_nonfinite.obj raccel_main.obj raccel_sup.obj raccel_mat.obj simulink_solver_api.obj raccel_utils.obj slsa_sim_common_utils.obj main.obj ext_svr.obj updown.obj ext_work.obj rtiostream_interface.obj rtiostream_tcpip.obj rtiostream_utils.obj
...
%.obj : $(START_DIR)/slprj/raccel/SineWave/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/raccel/SineWave/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/raccel/SineWave/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/raccel/SineWave/%.cp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/raccel/SineWave/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
SineWave.obj : $(START_DIR)/slprj/raccel/SineWave/SineWave.c
	$(CC) $(CFLAGS) -o "$@" "$<"


SineWave_capi.obj : $(START_DIR)/slprj/raccel/SineWave/SineWave_capi.c
	$(CC) $(CFLAGS) -o "$@" "$<"


SineWave_data.obj : $(START_DIR)/slprj/raccel/SineWave/SineWave_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


SineWave_tgtconn.obj : $(START_DIR)/slprj/raccel/SineWave/SineWave_tgtconn.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rt_nonfinite.obj : $(START_DIR)/slprj/raccel/SineWave/rt_nonfinite.c
	$(CC) $(CFLAGS) -o "$@" "$<"
