...
struct { struct { void * AQHandles ; } oldmdbjs1r ; struct { void * AQHandles
; } fyjfufhnwn ; struct { void * LoggedData ; } izrdodcpto ; } DW ; typedef
struct { real_T nnmrj1tmah ; real_T i41kv0u5az ; } X ; typedef struct {
real_T nnmrj1tmah ; real_T i41kv0u5az ; } XDot ; typedef struct { boolean_T
nnmrj1tmah ; boolean_T i41kv0u5az ; } XDis ; typedef struct { real_T
nnmrj1tmah ; real_T i41kv0u5az ; } CStateAbsTol ; typedef struct { real_T
nnmrj1tmah ; real_T i41kv0u5az ; } CXPtMin ; typedef struct { real_T
nnmrj1tmah ; real_T i41kv0u5az ; } CXPtMax ; typedef struct { real_T
mqrudzltlm ; } ExtU ; typedef struct { rtwCAPI_ModelMappingInfo mmi ; }
DataMapInfo ; struct P_ { real_T b ; real_T k ; real_T m ; real_T
Integrator1_IC ; real_T Integrator2_IC ; } ; extern const char_T *
RT_MEMORY_ALLOCATION_ERROR ; extern B rtB ; extern X rtX ; extern DW rtDW ;
extern ExtU rtU ; extern P rtP ; extern mxArray *
