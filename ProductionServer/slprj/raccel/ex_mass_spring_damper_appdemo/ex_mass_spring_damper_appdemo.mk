###########################################################################
## Makefile generated for component 'ex_mass_spring_damper_appdemo'. 
## 
## Makefile     : ex_mass_spring_damper_appdemo.mk
## Generated on : Thu Jan 15 16:56:48 2026
## Final product: ./ex_mass_spring_damper_appdemo.exe
...
PRODUCT_NAME              = ex_mass_spring_damper_appdemo
MAKEFILE                  = ex_mass_spring_damper_appdemo.mk
MATLAB_ROOT               = C:/PROGRA~1/MATLAB/PARALL~1/R2025b
MATLAB_BIN                = C:/PROGRA~1/MATLAB/PARALL~1/R2025b/bin
MATLAB_ARCH_BIN           = $(MATLAB_BIN)/win64
START_DIR                 = C:/Users/Demo/Documents/MATLAB/Simulink/ProductionServer
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 1
TGT_FCN_LIB               = ISO_C
...
COMPILER_COMMAND_FILE     = ex_mass_spring_damper_appdemo_comp.rsp
CMD_FILE                  = ex_mass_spring_damper_appdemo.rsp
...
PRODUCT = ./ex_mass_spring_damper_appdemo.exe
...
DEFINES_STANDARD = -DMODEL=ex_mass_spring_damper_appdemo -DNUMST=2 -DNCSTATES=2 -DHAVESTDIO
...
SRCS = $(START_DIR)/slprj/raccel/ex_mass_spring_damper_appdemo/ex_mass_spring_damper_appdemo.c $(START_DIR)/slprj/raccel/ex_mass_spring_damper_appdemo/ex_mass_spring_damper_appdemo_capi.c $(START_DIR)/slprj/raccel/ex_mass_spring_damper_appdemo/ex_mass_spring_damper_appdemo_data.c $(START_DIR)/slprj/raccel/ex_mass_spring_damper_appdemo/ex_mass_spring_damper_appdemo_tgtconn.c $(START_DIR)/slprj/raccel/ex_mass_spring_damper_appdemo/rtGetInf.c $(START_DIR)/slprj/raccel/ex_mass_spring_damper_appdemo/rt_nonfinite.c $(MATLAB_ROOT)/rtw/c/raccel/raccel_main.c $(MATLAB_ROOT)/rtw/c/raccel/raccel_sup.c $(MATLAB_ROOT)/rtw/c/raccel/raccel_mat.c $(MATLAB_ROOT)/simulink/include/simulink_solver_api.c $(MATLAB_ROOT)/rtw/c/src/rapid/raccel_utils.c $(MATLAB_ROOT)/rtw/c/src/rapid/slsa_sim_common_utils.c $(MATLAB_ROOT)/rtw/c/raccel/main.c $(MATLAB_ROOT)/rtw/c/src/ext_mode/common/ext_svr.c $(MATLAB_ROOT)/rtw/c/src/ext_mode/common/updown.c $(MATLAB_ROOT)/rtw/c/src/ext_mode/common/ext_work.c $(MATLAB_ROOT)/rtw/c/src/ext_mode/common/rtiostream_interface.c $(MATLAB_ROOT)/toolbox/coder/rtiostream/src/rtiostreamtcpip/rtiostream_tcpip.c $(MATLAB_ROOT)/toolbox/coder/rtiostream/src/utils/rtiostream_utils.c
...
OBJS = ex_mass_spring_damper_appdemo.obj ex_mass_spring_damper_appdemo_capi.obj ex_mass_spring_damper_appdemo_data.obj ex_mass_spring_damper_appdemo_tgtconn.obj rtGetInf.obj rt_nonfinite.obj raccel_main.obj raccel_sup.obj raccel_mat.obj simulink_solver_api.obj raccel_utils.obj slsa_sim_common_utils.obj main.obj ext_svr.obj updown.obj ext_work.obj rtiostream_interface.obj rtiostream_tcpip.obj rtiostream_utils.obj
...
%.obj : $(START_DIR)/slprj/raccel/ex_mass_spring_damper_appdemo/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/raccel/ex_mass_spring_damper_appdemo/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/raccel/ex_mass_spring_damper_appdemo/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/raccel/ex_mass_spring_damper_appdemo/%.cp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/raccel/ex_mass_spring_damper_appdemo/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
ex_mass_spring_damper_appdemo.obj : $(START_DIR)/slprj/raccel/ex_mass_spring_damper_appdemo/ex_mass_spring_damper_appdemo.c
	$(CC) $(CFLAGS) -o "$@" "$<"


ex_mass_spring_damper_appdemo_capi.obj : $(START_DIR)/slprj/raccel/ex_mass_spring_damper_appdemo/ex_mass_spring_damper_appdemo_capi.c
	$(CC) $(CFLAGS) -o "$@" "$<"


ex_mass_spring_damper_appdemo_data.obj : $(START_DIR)/slprj/raccel/ex_mass_spring_damper_appdemo/ex_mass_spring_damper_appdemo_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


ex_mass_spring_damper_appdemo_tgtconn.obj : $(START_DIR)/slprj/raccel/ex_mass_spring_damper_appdemo/ex_mass_spring_damper_appdemo_tgtconn.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetInf.obj : $(START_DIR)/slprj/raccel/ex_mass_spring_damper_appdemo/rtGetInf.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rt_nonfinite.obj : $(START_DIR)/slprj/raccel/ex_mass_spring_damper_appdemo/rt_nonfinite.c
	$(CC) $(CFLAGS) -o "$@" "$<"
