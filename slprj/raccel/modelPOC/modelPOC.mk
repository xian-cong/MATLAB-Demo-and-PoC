###########################################################################
## Makefile generated for component 'modelPOC'. 
## 
## Makefile     : modelPOC.mk
## Generated on : Mon Jan 19 16:32:42 2026
## Final product: ./modelPOC.exe
...
COMPILER_COMMAND_FILE     = modelPOC_comp.rsp
CMD_FILE                  = modelPOC.rsp
...
DEFINES_STANDARD = -DMODEL=modelPOC -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO
...
SRCS = $(START_DIR)/slprj/raccel/modelPOC/csv_reader_accel_wrapper.c $(START_DIR)/slprj/raccel/modelPOC/modelPOC.c $(START_DIR)/slprj/raccel/modelPOC/modelPOC_capi.c $(START_DIR)/slprj/raccel/modelPOC/modelPOC_data.c $(START_DIR)/slprj/raccel/modelPOC/modelPOC_tgtconn.c $(START_DIR)/slprj/raccel/modelPOC/rt_nonfinite.c $(MATLAB_ROOT)/rtw/c/raccel/raccel_main.c $(MATLAB_ROOT)/rtw/c/raccel/raccel_sup.c $(MATLAB_ROOT)/rtw/c/raccel/raccel_mat.c $(MATLAB_ROOT)/simulink/include/simulink_solver_api.c $(MATLAB_ROOT)/rtw/c/src/rapid/raccel_utils.c $(MATLAB_ROOT)/rtw/c/src/rapid/slsa_sim_common_utils.c $(MATLAB_ROOT)/rtw/c/raccel/main.c $(MATLAB_ROOT)/rtw/c/src/ext_mode/common/ext_svr.c $(MATLAB_ROOT)/rtw/c/src/ext_mode/common/updown.c $(MATLAB_ROOT)/rtw/c/src/ext_mode/common/ext_work.c $(MATLAB_ROOT)/rtw/c/src/ext_mode/common/rtiostream_interface.c $(MATLAB_ROOT)/toolbox/coder/rtiostream/src/rtiostreamtcpip/rtiostream_tcpip.c $(MATLAB_ROOT)/toolbox/coder/rtiostream/src/utils/rtiostream_utils.c $(START_DIR)/csv_reader_wrapper.c
...
OBJS = csv_reader_accel_wrapper.obj modelPOC.obj modelPOC_capi.obj modelPOC_data.obj modelPOC_tgtconn.obj rt_nonfinite.obj raccel_main.obj raccel_sup.obj raccel_mat.obj simulink_solver_api.obj raccel_utils.obj slsa_sim_common_utils.obj main.obj ext_svr.obj updown.obj ext_work.obj rtiostream_interface.obj rtiostream_tcpip.obj rtiostream_utils.obj csv_reader_wrapper.obj
...
%.obj : $(START_DIR)/slprj/raccel/modelPOC/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/raccel/modelPOC/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/raccel/modelPOC/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/raccel/modelPOC/%.cp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/raccel/modelPOC/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
csv_reader_accel_wrapper.obj : $(START_DIR)/slprj/raccel/modelPOC/csv_reader_accel_wrapper.c
	$(CC) $(CFLAGS) -o "$@" "$<"


modelPOC.obj : $(START_DIR)/slprj/raccel/modelPOC/modelPOC.c
	$(CC) $(CFLAGS) -o "$@" "$<"


modelPOC_capi.obj : $(START_DIR)/slprj/raccel/modelPOC/modelPOC_capi.c
	$(CC) $(CFLAGS) -o "$@" "$<"


modelPOC_data.obj : $(START_DIR)/slprj/raccel/modelPOC/modelPOC_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


modelPOC_tgtconn.obj : $(START_DIR)/slprj/raccel/modelPOC/modelPOC_tgtconn.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rt_nonfinite.obj : $(START_DIR)/slprj/raccel/modelPOC/rt_nonfinite.c
	$(CC) $(CFLAGS) -o "$@" "$<"
...
csv_reader_wrapper.obj : $(START_DIR)/csv_reader_wrapper.c
	$(CC) $(CFLAGS) -o "$@" "$<"
