###########################################################################
## Makefile generated for component 'callback_demo_with_callbacks'. 
## 
## Makefile     : callback_demo_with_callbacks.mk
## Generated on : Tue Feb 10 14:12:11 2026
## Final product: ./callback_demo_with_callbacks.exe
...
PRODUCT_NAME              = callback_demo_with_callbacks
MAKEFILE                  = callback_demo_with_callbacks.mk
...
COMPILER_COMMAND_FILE     = callback_demo_with_callbacks_comp.rsp
CMD_FILE                  = callback_demo_with_callbacks.rsp
...
PRODUCT = ./callback_demo_with_callbacks.exe
...
DEFINES_STANDARD = -DMODEL=callback_demo_with_callbacks -DNUMST=2 -DNCSTATES=0 -DHAVESTDIO
...
SRCS = $(START_DIR)/slprj/raccel/callback_demo_with_callbacks/callback_demo_with_callbacks.c $(START_DIR)/slprj/raccel/callback_demo_with_callbacks/callback_demo_with_callbacks_capi.c $(START_DIR)/slprj/raccel/callback_demo_with_callbacks/callback_demo_with_callbacks_data.c $(START_DIR)/slprj/raccel/callback_demo_with_callbacks/callback_demo_with_callbacks_tgtconn.c $(START_DIR)/slprj/raccel/callback_demo_with_callbacks/rt_nonfinite.c $(MATLAB_ROOT)/rtw/c/raccel/raccel_main.c $(MATLAB_ROOT)/rtw/c/raccel/raccel_sup.c $(MATLAB_ROOT)/rtw/c/raccel/raccel_mat.c $(MATLAB_ROOT)/simulink/include/simulink_solver_api.c $(MATLAB_ROOT)/rtw/c/src/rapid/raccel_utils.c $(MATLAB_ROOT)/rtw/c/src/rapid/slsa_sim_common_utils.c $(MATLAB_ROOT)/rtw/c/raccel/main.c $(MATLAB_ROOT)/rtw/c/src/ext_mode/common/ext_svr.c $(MATLAB_ROOT)/rtw/c/src/ext_mode/common/updown.c $(MATLAB_ROOT)/rtw/c/src/ext_mode/common/ext_work.c $(MATLAB_ROOT)/rtw/c/src/ext_mode/common/rtiostream_interface.c $(MATLAB_ROOT)/toolbox/coder/rtiostream/src/rtiostreamtcpip/rtiostream_tcpip.c $(MATLAB_ROOT)/toolbox/coder/rtiostream/src/utils/rtiostream_utils.c
...
OBJS = callback_demo_with_callbacks.obj callback_demo_with_callbacks_capi.obj callback_demo_with_callbacks_data.obj callback_demo_with_callbacks_tgtconn.obj rt_nonfinite.obj raccel_main.obj raccel_sup.obj raccel_mat.obj simulink_solver_api.obj raccel_utils.obj slsa_sim_common_utils.obj main.obj ext_svr.obj updown.obj ext_work.obj rtiostream_interface.obj rtiostream_tcpip.obj rtiostream_utils.obj
...
%.obj : $(START_DIR)/slprj/raccel/callback_demo_with_callbacks/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/raccel/callback_demo_with_callbacks/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/raccel/callback_demo_with_callbacks/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/raccel/callback_demo_with_callbacks/%.cp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/raccel/callback_demo_with_callbacks/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
callback_demo_with_callbacks.obj : $(START_DIR)/slprj/raccel/callback_demo_with_callbacks/callback_demo_with_callbacks.c
	$(CC) $(CFLAGS) -o "$@" "$<"


callback_demo_with_callbacks_capi.obj : $(START_DIR)/slprj/raccel/callback_demo_with_callbacks/callback_demo_with_callbacks_capi.c
	$(CC) $(CFLAGS) -o "$@" "$<"


callback_demo_with_callbacks_data.obj : $(START_DIR)/slprj/raccel/callback_demo_with_callbacks/callback_demo_with_callbacks_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


callback_demo_with_callbacks_tgtconn.obj : $(START_DIR)/slprj/raccel/callback_demo_with_callbacks/callback_demo_with_callbacks_tgtconn.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rt_nonfinite.obj : $(START_DIR)/slprj/raccel/callback_demo_with_callbacks/rt_nonfinite.c
	$(CC) $(CFLAGS) -o "$@" "$<"
