###########################################################################
## Makefile generated for component 'combined_callback_csv_model_time'. 
## 
## Makefile     : combined_callback_csv_model_time.mk
## Generated on : Tue Feb 10 23:29:13 2026
## Final product: ./combined_callback_csv_model_time.exe
...
PRODUCT_NAME              = combined_callback_csv_model_time
MAKEFILE                  = combined_callback_csv_model_time.mk
MATLAB_ROOT               = C:/PROGRA~1/MATLAB/R2025b
MATLAB_BIN                = C:/PROGRA~1/MATLAB/R2025b/bin
MATLAB_ARCH_BIN           = $(MATLAB_BIN)/win64
START_DIR                 = C:/demo/simulink_compiler_callbacks
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 1
TGT_FCN_LIB               = ISO_C
...
COMPILER_COMMAND_FILE     = combined_callback_csv_model_time_comp.rsp
CMD_FILE                  = combined_callback_csv_model_time.rsp
...
PRODUCT = ./combined_callback_csv_model_time.exe
...
DEFINES_STANDARD = -DMODEL=combined_callback_csv_model_time -DNUMST=2 -DNCSTATES=0 -DHAVESTDIO
...
SRCS = $(START_DIR)/slprj/raccel/combined_callback_csv_model_time/combined_callback_csv_model_time.c $(START_DIR)/slprj/raccel/combined_callback_csv_model_time/combined_callback_csv_model_time_capi.c $(START_DIR)/slprj/raccel/combined_callback_csv_model_time/combined_callback_csv_model_time_data.c $(START_DIR)/slprj/raccel/combined_callback_csv_model_time/combined_callback_csv_model_time_tgtconn.c $(START_DIR)/slprj/raccel/combined_callback_csv_model_time/rtGetInf.c $(START_DIR)/slprj/raccel/combined_callback_csv_model_time/rtGetNaN.c $(START_DIR)/slprj/raccel/combined_callback_csv_model_time/rt_nonfinite.c $(MATLAB_ROOT)/rtw/c/raccel/raccel_main.c $(MATLAB_ROOT)/rtw/c/raccel/raccel_sup.c $(MATLAB_ROOT)/rtw/c/raccel/raccel_mat.c $(MATLAB_ROOT)/simulink/include/simulink_solver_api.c $(MATLAB_ROOT)/rtw/c/src/rapid/raccel_utils.c $(MATLAB_ROOT)/rtw/c/src/rapid/slsa_sim_common_utils.c $(MATLAB_ROOT)/rtw/c/raccel/main.c $(MATLAB_ROOT)/rtw/c/src/ext_mode/common/ext_svr.c $(MATLAB_ROOT)/rtw/c/src/ext_mode/common/updown.c $(MATLAB_ROOT)/rtw/c/src/ext_mode/common/ext_work.c $(MATLAB_ROOT)/rtw/c/src/ext_mode/common/rtiostream_interface.c $(MATLAB_ROOT)/toolbox/coder/rtiostream/src/rtiostreamtcpip/rtiostream_tcpip.c $(MATLAB_ROOT)/toolbox/coder/rtiostream/src/utils/rtiostream_utils.c
...
OBJS = combined_callback_csv_model_time.obj combined_callback_csv_model_time_capi.obj combined_callback_csv_model_time_data.obj combined_callback_csv_model_time_tgtconn.obj rtGetInf.obj rtGetNaN.obj rt_nonfinite.obj raccel_main.obj raccel_sup.obj raccel_mat.obj simulink_solver_api.obj raccel_utils.obj slsa_sim_common_utils.obj main.obj ext_svr.obj updown.obj ext_work.obj rtiostream_interface.obj rtiostream_tcpip.obj rtiostream_utils.obj
...
%.obj : $(START_DIR)/slprj/raccel/combined_callback_csv_model_time/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/raccel/combined_callback_csv_model_time/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/raccel/combined_callback_csv_model_time/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/raccel/combined_callback_csv_model_time/%.cp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/raccel/combined_callback_csv_model_time/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
combined_callback_csv_model_time.obj : $(START_DIR)/slprj/raccel/combined_callback_csv_model_time/combined_callback_csv_model_time.c
	$(CC) $(CFLAGS) -o "$@" "$<"


combined_callback_csv_model_time_capi.obj : $(START_DIR)/slprj/raccel/combined_callback_csv_model_time/combined_callback_csv_model_time_capi.c
	$(CC) $(CFLAGS) -o "$@" "$<"


combined_callback_csv_model_time_data.obj : $(START_DIR)/slprj/raccel/combined_callback_csv_model_time/combined_callback_csv_model_time_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


combined_callback_csv_model_time_tgtconn.obj : $(START_DIR)/slprj/raccel/combined_callback_csv_model_time/combined_callback_csv_model_time_tgtconn.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetInf.obj : $(START_DIR)/slprj/raccel/combined_callback_csv_model_time/rtGetInf.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetNaN.obj : $(START_DIR)/slprj/raccel/combined_callback_csv_model_time/rtGetNaN.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rt_nonfinite.obj : $(START_DIR)/slprj/raccel/combined_callback_csv_model_time/rt_nonfinite.c
	$(CC) $(CFLAGS) -o "$@" "$<"
