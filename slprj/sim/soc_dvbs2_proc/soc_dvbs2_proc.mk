...
## Generated on : Mon Oct 27 17:43:04 2025
## Final product: ./soc_dvbs2_proclib.lib
...
MODELLIB                  = soc_dvbs2_proclib.lib
...
SRCS = $(START_DIR)/slprj/sim/soc_dvbs2_proc/soc_dvbs2_proc.c $(START_DIR)/slprj/sim/soc_dvbs2_proc/soc_dvbs2_proc_capi.c
...
OBJS = soc_dvbs2_proc.obj soc_dvbs2_proc_capi.obj
...
SYSTEM_LIBS = -L"$(MATLAB_ROOT)/extern/lib/win64/mingw64" -L"$(MATLAB_ROOT)/lib/win64" -L"C:/Program Files/MATLAB/R2025b/extern/lib/win64/mingw64" -llibmex -llibmwmathutil
...
%.obj : $(START_DIR)/slprj/sim/soc_dvbs2_proc/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/sim/soc_dvbs2_proc/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/sim/soc_dvbs2_proc/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/sim/soc_dvbs2_proc/%.cp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/sim/soc_dvbs2_proc/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
soc_dvbs2_proc.obj : $(START_DIR)/slprj/sim/soc_dvbs2_proc/soc_dvbs2_proc.c
	$(CC) $(CFLAGS) -o "$@" "$<"


soc_dvbs2_proc_capi.obj : $(START_DIR)/slprj/sim/soc_dvbs2_proc/soc_dvbs2_proc_capi.c
	$(CC) $(CFLAGS) -o "$@" "$<"
