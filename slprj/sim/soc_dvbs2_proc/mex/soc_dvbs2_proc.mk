...
## Generated on : Mon Oct 27 17:43:05 2025
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/soc_dvbs2_proc_msf.mexw64
...
MODELREF_LINK_RSPFILE     = soc_dvbs2_proc_ref.rsp
COMPILER_COMMAND_FILE     = soc_dvbs2_proc_comp.rsp
CMD_FILE                  = soc_dvbs2_proc.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/soc_dvbs2_proc_msf.mexw64
...
DEFINES_STANDARD = -DMODEL=soc_dvbs2_proc -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMDL_REF_SIM_TGT=1 -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
SRCS = $(START_DIR)/slprj/sim/soc_dvbs2_proc/soc_dvbs2_proc_msf.c $(MATLAB_ROOT)/extern/version/c_mexapi_version.c
...
OBJS = soc_dvbs2_proc_msf.obj c_mexapi_version.obj
...
MODELREF_LIBS = C:/demo/DVBS2ReceiverSoCExample/slprj/sim/soc_dvbs2_proc/soc_dvbs2_proclib.lib
...
SYSTEM_LIBS = -L"$(MATLAB_ROOT)/extern/lib/win64/mingw64" -L"$(MATLAB_ROOT)/lib/win64" -L"C:/Program Files/MATLAB/R2025b/extern/lib/win64/mingw64" -L"C:/Program Files/MATLAB/R2025b/lib/win64" -llibmwsoc_queue -llibmwipp -llibfixedpoint -llibmwmathutil -llibmwsl_AsyncioQueue -lsf_runtime -llibmwslexec_simlog -llibmwcoder_ToAsyncQueueTgtAppSvc -llibmwsl_simtarget_instrumentation -llibmwsl_simtarget_core -llibmwstringutil -llibemlrt -llibmx -llibmex
...
soc_dvbs2_proc_msf.obj : $(START_DIR)/slprj/sim/soc_dvbs2_proc/soc_dvbs2_proc_msf.c
	$(CC) $(CFLAGS) -o "$@" "$<"
