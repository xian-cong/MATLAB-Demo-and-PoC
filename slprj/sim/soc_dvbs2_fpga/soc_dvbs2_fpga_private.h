#ifndef soc_dvbs2_fpga_private_h_
#define soc_dvbs2_fpga_private_h_
#include "rtwtypes.h"
...
#endif
typedef struct { uint8_T m53huuhm5v [ 16 ] ; uint8_T akzwr3vujs [ 15 ] ;
uint8_T nxqnsaasmb [ 15 ] ; uint8_T bbcsnaidf0 [ 19 ] ; uint8_T bbbjaf05mc [
18 ] ; uint8_T hj4vzcvsf2 [ 18 ] ; uint8_T pf2zvuciin [ 19 ] ; uint8_T
la4bnsdkxe [ 18 ] ; } oqbc1p32xw ; extern f5p2uvi2azu f5p2uvi2az ; extern
const oqbc1p32xw oqbc1p32xwx ;
#endif
