...
public class MatlabController {
    ...
    private static void processRequest(int reqNum) throws Exception {
        ...
        String inputFile = INPUT_DIR + "\\data_" + timestamp + ".txt";
        String outputFile = OUTPUT_DIR + "\\result_" + timestamp + ".txt";
        ...
        log("[REQUEST] Waiting for result file: " + Paths.get(outputFile).getFileName());
