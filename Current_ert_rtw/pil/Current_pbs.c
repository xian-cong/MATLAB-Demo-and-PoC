 ...
 * Component: Current
 * Component Simulink Path: Current
 * Simulation Mode: PIL
 *
 */

#define S_FUNCTION_NAME                Current_pbs
                      ...
                      mem_unit_type_T dataTypeId)
{
  ...
  return xilReadDataInternal(dst, numElements, dataTypeId, false, IOBufferPtr,
    pMemUnitTransformer, 2, pXILService);
}
  ...
  mem_unit_type_T dataTypeId)
{
  ...
  pMemUnitTransformer = (void *) ssGetPWorkValue(S, 14);
  pXILService = (void *) ssGetPWorkValue(S, 9);
  return xilWriteDataInternal(src, numElements, dataTypeId, false, IOBufferPtr,
    pMemUnitTransformer, 2, pXILService);
}
...
static boolean_T processResponseError(SimStruct * S)
{
  ...
  void * pMemUnitTransformer = (void *) ssGetPWorkValue(S, 14);
  void * pXILService = (void *) ssGetPWorkValue(S, 9);
  if (xilReadDataInternal((uint8_T*)&errorId, 1, MEM_UNIT_UINT16_TYPE, true,
                          IOBufferPtr, pMemUnitTransformer, 2, pXILService) !=
      XILHOSTAPPSVC_SUCCESS) {
    return XILHOSTAPPSVC_ERROR;
  }                                    /* if */
...
static boolean_T processResponsePrintf(SimStruct * S)
{
  ...
  {
    {
...

      {
        ...
        {
          if (xilReadData(S, (uint8_T*)simDataMemUnitPtr, num_elements,
  ...
  if (PRINTF_ERROR != TARGET_IO_SUCCESS) {
    ...
    if (pPrintBuff != NULL) {
      uint16_T *tempBuff;
      tempBuff = (uint16_T *) mxCalloc(PRINTF_SIZE, sizeof(uint16_T));
      XIL_IOBuffer_T * IOBufferPtr = (XIL_IOBuffer_T *) ssGetPWorkValue(S, 1);
      void * pMemUnitTransformer = (void *) ssGetPWorkValue(S, 14);
      void * pXILService = (void *) ssGetPWorkValue(S, 9);
      if (xilReadDataInternal((uint8_T*)&(tempBuff[0]), PRINTF_SIZE,
                              MEM_UNIT_UINT16_TYPE, true, IOBufferPtr,
                              pMemUnitTransformer, 2, pXILService) !=
          XILHOSTAPPSVC_SUCCESS) {
        return XILHOSTAPPSVC_ERROR;
      }                                /* if */
      ...
      for (i=0; i<PRINTF_SIZE; i++) {
        pPrintBuff[i] = (uint8_T) (tempBuff)[i];
      }                                /* for */
  ...
  if (targetIOFdPtr != NULL) {
    ...
    if (targetIOFdPtr->fidOffset + 1 == FOPEN_FID) {
      ...
      if (targetIOFdPtr->Fd != NULL) {
        ...
        if (pFopenBuff != NULL) {
          uint16_T *tempBuff;
          tempBuff = (uint16_T *) mxCalloc(FOPEN_NAME_SIZE, sizeof(uint16_T));
          XIL_IOBuffer_T * IOBufferPtr = (XIL_IOBuffer_T *) ssGetPWorkValue(S, 1);
          void * pMemUnitTransformer = (void *) ssGetPWorkValue(S, 14);
          void * pXILService = (void *) ssGetPWorkValue(S, 9);
          if (xilReadDataInternal((uint8_T*)&(tempBuff[0]), FOPEN_NAME_SIZE,
                                  MEM_UNIT_UINT16_TYPE, true, IOBufferPtr,
                                  pMemUnitTransformer, 2, pXILService) !=
              XILHOSTAPPSVC_SUCCESS) {
            return XILHOSTAPPSVC_ERROR;
          ...
          for (i=0; i<FOPEN_NAME_SIZE; i++) {
            pFopenBuff[i] = (uint8_T) (tempBuff)[i];
          }                            /* for */
      ...
      if (targetIOFdPtr->size > FPRINTF_FID) {
        if (targetIOFdPtr->Fd[FPRINTF_FID] != NULL) {
          ...
          if (pFprintfBuff != NULL) {
            uint16_T *tempBuff;
            tempBuff = (uint16_T *) mxCalloc(FPRINTF_SIZE, sizeof(uint16_T));
            XIL_IOBuffer_T * IOBufferPtr = (XIL_IOBuffer_T *) ssGetPWorkValue(S,
              1);
            void * pMemUnitTransformer = (void *) ssGetPWorkValue(S, 14);
            void * pXILService = (void *) ssGetPWorkValue(S, 9);
            if (xilReadDataInternal((uint8_T*)&(tempBuff[0]), FPRINTF_SIZE,
                                    MEM_UNIT_UINT16_TYPE, true, IOBufferPtr,
                                    pMemUnitTransformer, 2, pXILService) !=
                XILHOSTAPPSVC_SUCCESS) {
              return XILHOSTAPPSVC_ERROR;
            ...
            for (i=0; i<FPRINTF_SIZE; i++) {
              pFprintfBuff[i] = (uint8_T) (tempBuff)[i];
            }                          /* for */
        ...
        if (IOBufferPtr != NULL) {
          ...
          if (pXILService != NULL) {
            ...
            if (IOBufferPtr->data != NULL) {
              /* write command id */
              {
                uint16_T commandDataArg = (uint16_T) XIL_PROCESS_PARAMS_COMMAND;
                XIL_IOBuffer_T * IOBufferPtr = (XIL_IOBuffer_T *)
                  ssGetPWorkValue(S, 1);
                void * pMemUnitTransformer = (void *) ssGetPWorkValue(S, 14);
                void * pXILService = (void *) ssGetPWorkValue(S, 9);
                if (xilWriteDataInternal((uint8_T*)&commandDataArg, 1,
                     MEM_UNIT_UINT16_TYPE, true, IOBufferPtr,
                     pMemUnitTransformer, 2, pXILService) !=
                    XILHOSTAPPSVC_SUCCESS) {
                  return;
              ...
              {
                {
...

                  {
                    ...
                    {
                      if (xilWriteData(S, (uint8_T*)simDataMemUnitPtr,
                                       num_elements, MEM_UNIT_UINT32_TYPE) !=
                          XILHOSTAPPSVC_SUCCESS) {
                        return;
                      }                /* if */
                    }
            ...
            while (commandResponseType != XIL_STEP_COMPLETE) {
              ...
              if (IOBufferPtr->readData) {
                ...
                while (IOBufferPtr->readData) {
                  ...
                  void * pMemUnitTransformer = (void *) ssGetPWorkValue(S, 14);
                  void * pXILService = (void *) ssGetPWorkValue(S, 9);
                  if (xilReadDataInternal((uint8_T*)&responseId, 1,
                                          MEM_UNIT_UINT16_TYPE, true,
                                          IOBufferPtr, pMemUnitTransformer, 2,
                                          pXILService) != XILHOSTAPPSVC_SUCCESS)
                  {
                    return;
                  }                    /* if */
...
static boolean_T startAndSetupApplication(SimStruct *S)
{
...

  {
...

    {
      ...
      rtIOStreamDataPtr->targetSendBufferSizeBytes = 128 + 2;
...

  {
...

    {
      ...
      if (codeInstrHostAppSvcCreate(&pCodeInstrService, pCodeInstrServiceData,
           pComms, pMemUnitTransformer, 16, pXILUtils, memUnitSizeBytes, 0,
    ...
    {
      mxArray * codeGenComponent = mxCreateString("mcb_pmsm_foc_sim");
      mxArray *rhs[3];
      const char * simulinkBlockPath = ssGetPath(S);
      rhs[ 0 ] = mxCreateString(
        "@coder.connectivity.SimulinkInterface.getSILPILInterface");
    ...
    if (IOBufferPtr != NULL) {
      ...
      if (pXILService != NULL) {
        ...
        if (IOBufferPtr->data != NULL) {
          /* write command id */
          {
            uint16_T commandDataArg = (uint16_T) XIL_INIT_COMMAND;
            XIL_IOBuffer_T * IOBufferPtr = (XIL_IOBuffer_T *) ssGetPWorkValue(S,
              1);
            void * pMemUnitTransformer = (void *) ssGetPWorkValue(S, 14);
            void * pXILService = (void *) ssGetPWorkValue(S, 9);
            if (xilWriteDataInternal((uint8_T*)&commandDataArg, 1,
                 MEM_UNIT_UINT16_TYPE, true, IOBufferPtr, pMemUnitTransformer, 2,
                 pXILService) != XILHOSTAPPSVC_SUCCESS) {
              return false;
            }                          /* if */
          }
          ...
          {
            {
...

              {
                ...
                {
                  if (xilWriteData(S, (uint8_T*)simDataMemUnitPtr, num_elements,
...
#define RESPONSE_TYPE_SIZE             8
            ...
            while (IOBufferPtr->readData) {
              /* read response id */
              XIL_IOBuffer_T * IOBufferPtr = (XIL_IOBuffer_T *) ssGetPWorkValue
                (S, 1);
              void * pMemUnitTransformer = (void *) ssGetPWorkValue(S, 14);
              void * pXILService = (void *) ssGetPWorkValue(S, 9);
              if (xilReadDataInternal((uint8_T*)&responseId, 1,
               ...
               case RESPONSE_TYPE_SIZE:
                {
                  ...
                  void * pMemUnitTransformer = (void *) ssGetPWorkValue(S, 14);
                  void * pXILService = (void *) ssGetPWorkValue(S, 9);
                  if (xilReadDataInternal((uint8_T*)&typeId, 1,
                                          MEM_UNIT_UINT16_TYPE, true,
                                          IOBufferPtr, pMemUnitTransformer, 2,
                                          pXILService) != XILHOSTAPPSVC_SUCCESS)
                  {
                  ...
                  if (xilReadDataInternal((uint8_T*)&typeBytes, 1,
                                          MEM_UNIT_UINT16_TYPE, true,
                                          IOBufferPtr, pMemUnitTransformer, 2,
                                          pXILService) != XILHOSTAPPSVC_SUCCESS)
                  {
    ...
    if (IOBufferPtr != NULL) {
      ...
      if (pXILService != NULL) {
        ...
        if (IOBufferPtr->data != NULL) {
          /* write command id */
          {
            uint16_T commandDataArg = (uint16_T) XIL_INITIALIZE_COMMAND;
            XIL_IOBuffer_T * IOBufferPtr = (XIL_IOBuffer_T *) ssGetPWorkValue(S,
              1);
            void * pMemUnitTransformer = (void *) ssGetPWorkValue(S, 14);
            void * pXILService = (void *) ssGetPWorkValue(S, 9);
                ...
                {
                  {
...

                    {
...

                      {
                        ...
                        {
                          if (xilReadData(S, (uint8_T*)simDataMemUnitPtr,
                                          num_elements, MEM_UNIT_INT32_TYPE) !=
                              XILHOSTAPPSVC_SUCCESS) {
                            return;
                          }            /* if */
                        }
...
static void mdlInitializeSizes(SimStruct *S)
{
  ...
  if (ssGetSimMode(S) != SS_SIMMODE_SIZES_CALL_ONLY) {
    ...
    /* fixedExp = -17 */
    /* bias = 0 */
    /* obeyDataTypeOverride = 0 */
    dataTypeId = ssRegisterDataTypeFxpFSlopeFixExpBias(S, 1, 32, 1, -17, 0, 0);
  ...
  ssSetInputPortSampleTime(S, 0, 5e-05);
  ...
  /* using port based sample times */
  ssSetInputPortSampleTime(S, 1, 5e-05);
  ...
  /* using port based sample times */
  ssSetOutputPortSampleTime(S, 0, 5e-05);
  ...
  /* using port based sample times */
  ssSetOutputPortSampleTime(S, 1, 5e-05);
...
static void mdlSetupRuntimeResources(SimStruct *S)
{
...

  {
    ...
    ssSetPWorkValue(S, 14, pMemUnitTransformer);
  }
      ...
      if (IOBufferPtr != NULL) {
        ...
        if (pXILService != NULL) {
          ...
          if (IOBufferPtr->data != NULL) {
            /* write command id */
            {
              uint16_T commandDataArg = (uint16_T) XIL_PAUSE_COMMAND;
              XIL_IOBuffer_T * IOBufferPtr = (XIL_IOBuffer_T *) ssGetPWorkValue
                (S, 1);
              void * pMemUnitTransformer = (void *) ssGetPWorkValue(S, 14);
              void * pXILService = (void *) ssGetPWorkValue(S, 9);
              if (xilWriteDataInternal((uint8_T*)&commandDataArg, 1,
                   MEM_UNIT_UINT16_TYPE, true, IOBufferPtr, pMemUnitTransformer,
                   2, pXILService) != XILHOSTAPPSVC_SUCCESS) {
                return;
              }                        /* if */
            }
...
static void XILoutputTID01(SimStruct *S, int tid)
{
...

  {
    ...
    if (IOBufferPtr != NULL) {
      void * pXILService = (void *) ssGetPWorkValue(S, 9);
      if (pXILService != NULL) {
        if (xilHostAppSvcGrowIOBuffer(pXILService, IOBufferPtr, (13) * 2, 0)!=
            XILHOSTAPPSVC_SUCCESS) {
          return;
        }                              /* if */
        ...
        if (IOBufferPtr->data != NULL) {
          /* write command id */
          {
            uint16_T commandDataArg = (uint16_T) XIL_OUTPUT_COMMAND;
            XIL_IOBuffer_T * IOBufferPtr = (XIL_IOBuffer_T *) ssGetPWorkValue(S,
              1);
            void * pMemUnitTransformer = (void *) ssGetPWorkValue(S, 14);
            void * pXILService = (void *) ssGetPWorkValue(S, 9);
...

  {
    ...
    if (IOBufferPtr->readData) {
      ...
      while (IOBufferPtr->readData) {
        ...
        void * pMemUnitTransformer = (void *) ssGetPWorkValue(S, 14);
        void * pXILService = (void *) ssGetPWorkValue(S, 9);
        if (xilReadDataInternal((uint8_T*)&responseId, 1, MEM_UNIT_UINT16_TYPE,
                                true, IOBufferPtr, pMemUnitTransformer, 2,
                                pXILService) != XILHOSTAPPSVC_SUCCESS) {
          return;
        }                              /* if */
        ...
        if (IOBufferPtr != NULL) {
          ...
          if (pXILService != NULL) {
            ...
            if (IOBufferPtr->data != NULL) {
              /* write command id */
              {
                uint16_T commandDataArg = (uint16_T) XIL_TERMINATE_COMMAND;
                XIL_IOBuffer_T * IOBufferPtr = (XIL_IOBuffer_T *)
                  ssGetPWorkValue(S, 1);
                void * pMemUnitTransformer = (void *) ssGetPWorkValue(S, 14);
                void * pXILService = (void *) ssGetPWorkValue(S, 9);
        ...
        if (IOBufferPtr != NULL) {
          ...
          if (pXILService != NULL) {
            ...
            if (IOBufferPtr->data != NULL) {
              /* write command id */
              {
                uint16_T commandDataArg = (uint16_T) XIL_SHUTDOWN_COMMAND;
                XIL_IOBuffer_T * IOBufferPtr = (XIL_IOBuffer_T *)
                  ssGetPWorkValue(S, 1);
                void * pMemUnitTransformer = (void *) ssGetPWorkValue(S, 14);
                void * pXILService = (void *) ssGetPWorkValue(S, 9);
