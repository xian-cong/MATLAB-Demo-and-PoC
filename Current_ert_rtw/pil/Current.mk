###########################################################################
## Makefile generated for component 'Current'. 
## 
## Makefile     : Current.mk
## Generated on : Fri Jan 23 10:39:31 2026
## Final product: ./Current.out
...
START_DIR                 = C:/Users/KoayXianCong/Documents/MATLAB/Examples/R2025b/mcb/CodeVerificationAndProfilingUsingPILTestingExample
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = TI C28x
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I$(START_DIR)/Current_ert_rtw/instrumented -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert -I$(MATLAB_ROOT)/toolbox/c2b/tic2000/src -I$(MATLAB_ROOT)/toolbox/c2b/tic2000_shared/src -I$(MATLAB_ROOT)/toolbox/c2b/tic2000_shared/inc -I$(MATLAB_ROOT)/toolbox/c2b/tic2000/inc -IC:/ti/controlSUITE/device_support/f2806x/v151/F2806x_common/include -IC:/ti/controlSUITE/device_support/f2806x/v151/F2806x_headers/include -IC:/ti/controlSUITE//libs/math/CLAmath/v400/include -IC:/ti/controlSUITE//libs/math/IQmath/v160/include -I$(MATLAB_ROOT)/toolbox/shared/can/src/scanutil -IC:/ti/controlSUITE//libs/utilities/hrcap_hccal/type0/v110/include -I$(MATLAB_ROOT)/toolbox/c2b/tic2000_soc/src/ipclite -I$(MATLAB_ROOT)/toolbox/c2b/tic2000_soc/inc/ipclite -I$(MATLAB_ROOT)/toolbox/rtw/targets/pil/c -I$(START_DIR)/Current_ert_rtw/pil -I$(MATLAB_ROOT)/extern/include/coder/connectivity/XILTgtAppSvc -I$(MATLAB_ROOT)/toolbox/coder/rtiostream/src/utils -I$(MATLAB_ROOT)/toolbox/coder/rtiostream/src -I$(MATLAB_ROOT)/extern/include/coder/connectivity/CoderAssumpTgtAppSvc -I$(START_DIR)/Current_ert_rtw/coderassumptions -I$(MATLAB_ROOT)/extern/include/coder/connectivity/CodeInstrTgtAppSvc -I$(MATLAB_ROOT)/toolbox/c2b/tic2000_base/src
...
DEFINES_CUSTOM = 
DEFINES_OPTS = -DTID01EQ=0 -DCODER_ASSUMPTIONS_ENABLED=1 -DRTIOSTREAM_RX_BUFFER_BYTE_SIZE=128 -DRTIOSTREAM_TX_BUFFER_BYTE_SIZE=128 -DCODE_INSTRUMENTATION_ENABLED=1 -DMEM_UNIT_BYTES=2 -DMemUnit_T=uint16_T
...
DEFINES_STANDARD = -DMODEL=Current -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
MODELREF_LIBS = ../instrumented/MW_c28xx_csl.obj ../instrumented/MW_c28xx_board.obj ../instrumented/Current.obj ../instrumented/Current_data.obj

LIBS = C:/ti/controlSUITE/libs/math/FPUfastRTS/V100/lib/rts2800_fpu32_fast_supplement.lib C:/ti/controlSUITE/libs/utilities/hrcap_hccal/type0/v110/lib/HCCal_Type0_V1_fpu32.lib $(START_DIR)/Current_ert_rtw/coderassumptions/lib/Current_ca.lib C:/ProgramData/MATLAB/tic2000/3P.instrset/tic28xcodegentools.instrset/ti-cgt-c2000_22.6.0.LTS/lib/rts2800_fpu32.lib C:/ti/controlSUITE/libs/math/IQmath/v160/lib/IQmath_fpu32.lib $(MATLAB_ROOT)/toolbox/c2b/tic2000/src/c2806xPeripherals.cmd $(MATLAB_ROOT)/toolbox/c2b/tic2000/src/c28069M.cmd
...
$(PRODUCT) : $(OBJS) $(PREBUILT_OBJS) $(MODELREF_LIBS) $(LIBS)
	...
	$(LD) $(LDFLAGS) --output_file=$(PRODUCT) $(OBJS) ../instrumented/MW_c28xx_csl.obj ../instrumented/MW_c28xx_board.obj ../instrumented/Current.obj ../instrumented/Current_data.obj $(LIBS) $(SYSTEM_LIBS) $(TOOLCHAIN_LIBS)
...
%.obj : $(MATLAB_ROOT)/toolbox/rtw/targets/pil/c/%.cla
	$(CC) $(CFLAGS) --output_file="$@" "$<"
...
%.obj : $(MATLAB_ROOT)/toolbox/rtw/targets/pil/c/%.asm
	$(AS) $(ASFLAGS) --output_file="$@" "$<"
...
%.obj : $(MATLAB_ROOT)/toolbox/c2b/tic2000_shared/src/%.cla
	$(CC) $(CFLAGS) --output_file="$@" "$<"


%.obj : $(MATLAB_ROOT)/toolbox/c2b/tic2000_shared/src/%.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


%.obj : $(MATLAB_ROOT)/toolbox/c2b/tic2000_shared/src/%.asm
	$(AS) $(ASFLAGS) --output_file="$@" "$<"


%.obj : $(MATLAB_ROOT)/toolbox/c2b/tic2000_shared/src/%.cpp
	$(CPP) $(CPPFLAGS) --output_file="$@" "$<"
...
xil_interface.obj : $(START_DIR)/Current_ert_rtw/pil/xil_interface.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"
...
pil_main.obj : $(MATLAB_ROOT)/toolbox/rtw/targets/pil/c/pil_main.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"
...
xil_instrumentation.obj : $(START_DIR)/Current_ert_rtw/pil/xil_instrumentation.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"
