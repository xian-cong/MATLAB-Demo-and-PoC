   ...
   case XIL_OUTPUT_COMMAND:
    {
      ...
      if (!initComplete) {
        ...
        {
          void * dataAddress = (void *) &(Current_U.Idq_ref_PU[0]);
          xil_fcnid0_task1_output_u[tableIdx].memUnitLength = 2 * sizeof(int32_T);
          xil_fcnid0_task1_output_u[tableIdx++].address = (MemUnit_T *)
            dataAddress;
        }

        {
          void * dataAddress = (void *) &(Current_U.Feedbacks_sim[0]);
   ...
   case XIL_INITIALIZE_COMMAND:
    {
      ...
      if (!initComplete) {
...

        {
          ...
          xil_fcnid0_init_y[tableIdx].memUnitLength = 3 * sizeof(int32_T);
          xil_fcnid0_init_y[tableIdx++].address = (MemUnit_T *) dataAddress;
        }

        {
          void * dataAddress = (void *) &(Current_Y.Speed_fb);
   ...
   case XIL_OUTPUT_COMMAND:
    {
      ...
      if (!initComplete) {
        ...
        {
          void * dataAddress = (void *) &(Current_Y.DutyCycles[0]);
          xil_fcnid0_task1_y[tableIdx].memUnitLength = 3 * sizeof(int32_T);
