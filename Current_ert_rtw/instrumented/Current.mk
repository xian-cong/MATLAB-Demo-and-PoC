...
## 
## Makefile     : Current.mk
## Generated on : Fri Jan 23 10:37:11 2026
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/Current.out
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/Current.out
...
SRCS = $(START_DIR)/Current_ert_rtw/instrumented/MW_c28xx_csl.c $(START_DIR)/Current_ert_rtw/instrumented/MW_c28xx_board.c $(START_DIR)/Current_ert_rtw/instrumented/Current.c $(START_DIR)/Current_ert_rtw/instrumented/Current_data.c coder_profile_timer.c

MAIN_SRC = $(START_DIR)/Current_ert_rtw/instrumented/ert_main.c
...
OBJS = MW_c28xx_csl.obj MW_c28xx_board.obj Current.obj Current_data.obj coder_profile_timer.obj
...
LIBS = C:/ti/controlSUITE/libs/math/FPUfastRTS/V100/lib/rts2800_fpu32_fast_supplement.lib C:/ti/controlSUITE/libs/utilities/hrcap_hccal/type0/v110/lib/HCCal_Type0_V1_fpu32.lib
...
%.obj : $(START_DIR)/Current_ert_rtw/instrumented/%.cla
	$(CC) $(CFLAGS) --output_file="$@" "$<"


%.obj : $(START_DIR)/Current_ert_rtw/instrumented/%.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


%.obj : $(START_DIR)/Current_ert_rtw/instrumented/%.asm
	$(AS) $(ASFLAGS) --output_file="$@" "$<"


%.obj : $(START_DIR)/Current_ert_rtw/instrumented/%.cpp
	$(CPP) $(CPPFLAGS) --output_file="$@" "$<"


MW_c28xx_csl.obj : $(START_DIR)/Current_ert_rtw/instrumented/MW_c28xx_csl.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


MW_c28xx_board.obj : $(START_DIR)/Current_ert_rtw/instrumented/MW_c28xx_board.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


Current.obj : $(START_DIR)/Current_ert_rtw/instrumented/Current.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


Current_data.obj : $(START_DIR)/Current_ert_rtw/instrumented/Current_data.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


ert_main.obj : $(START_DIR)/Current_ert_rtw/instrumented/ert_main.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"
