...
## 
## Makefile     : Current.mk
## Generated on : Fri Jan 23 10:25:39 2026
...
SRCS = $(START_DIR)/Current_ert_rtw/MW_c28xx_csl.c $(START_DIR)/Current_ert_rtw/MW_c28xx_board.c $(START_DIR)/Current_ert_rtw/Current.c $(START_DIR)/Current_ert_rtw/Current_data.c

MAIN_SRC = $(START_DIR)/Current_ert_rtw/ert_main.c
...
OBJS = MW_c28xx_csl.obj MW_c28xx_board.obj Current.obj Current_data.obj
...
%.obj : $(START_DIR)/Current_ert_rtw/%.cla
	$(CC) $(CFLAGS) --output_file="$@" "$<"


%.obj : $(START_DIR)/Current_ert_rtw/%.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


%.obj : $(START_DIR)/Current_ert_rtw/%.asm
	$(AS) $(ASFLAGS) --output_file="$@" "$<"


%.obj : $(START_DIR)/Current_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) --output_file="$@" "$<"
...
MW_c28xx_csl.obj : $(START_DIR)/Current_ert_rtw/MW_c28xx_csl.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


MW_c28xx_board.obj : $(START_DIR)/Current_ert_rtw/MW_c28xx_board.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


Current.obj : $(START_DIR)/Current_ert_rtw/Current.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


Current_data.obj : $(START_DIR)/Current_ert_rtw/Current_data.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


ert_main.obj : $(START_DIR)/Current_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"
