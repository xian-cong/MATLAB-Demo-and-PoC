###########################################################################
## Makefile generated for component 'Current_ca'. 
## 
## Makefile     : Current_ca.mk
## Generated on : Fri Jan 23 10:37:32 2026
## Final product: ./Current_ca.lib
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I$(MATLAB_ROOT)/toolbox/rtw/targets/pil/c -I$(START_DIR)/Current_ert_rtw/coderassumptions -I$(START_DIR)/Current_ert_rtw -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert -I$(MATLAB_ROOT)/toolbox/c2b/tic2000/src -I$(MATLAB_ROOT)/toolbox/c2b/tic2000_shared/src -I$(MATLAB_ROOT)/toolbox/c2b/tic2000_shared/inc -I$(MATLAB_ROOT)/toolbox/c2b/tic2000/inc -IC:/ti/controlSUITE/device_support/f2806x/v151/F2806x_common/include -IC:/ti/controlSUITE/device_support/f2806x/v151/F2806x_headers/include -IC:/ti/controlSUITE//libs/math/CLAmath/v400/include -IC:/ti/controlSUITE//libs/math/IQmath/v160/include -I$(MATLAB_ROOT)/toolbox/shared/can/src/scanutil -IC:/ti/controlSUITE//libs/utilities/hrcap_hccal/type0/v110/include -I$(MATLAB_ROOT)/toolbox/c2b/tic2000_soc/src/ipclite -I$(MATLAB_ROOT)/toolbox/c2b/tic2000_soc/inc/ipclite
...
DEFINES_SKIPFORSIL = -DNRT -DXCP_CUSTOM_PLATFORM -DEXTMODE_DISABLE_ARGS_PROCESSING=1 -DMW_PIL_SCIFIFOLEN=4 -DMW_F2806X -DSTACK_SIZE=1024 -DF28069M -DCPU1 -DBOOT_FROM_FLASH=1 -DMW_FAST_RTS_INCLUDED=0 -DMW_HCCAL_INCLUDED=0
...
SRCS = $(MATLAB_ROOT)/toolbox/rtw/targets/pil/c/coder_assumptions_hwimpl.c $(MATLAB_ROOT)/toolbox/rtw/targets/pil/c/coder_assumptions_flt.c $(START_DIR)/Current_ert_rtw/coderassumptions/Current_ca.c
...
OBJS = coder_assumptions_hwimpl.obj coder_assumptions_flt.obj Current_ca.obj
...
%.obj : $(START_DIR)/Current_ert_rtw/coderassumptions/%.cla
	$(CC) $(CFLAGS) --output_file="$@" "$<"


%.obj : $(START_DIR)/Current_ert_rtw/coderassumptions/%.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


%.obj : $(START_DIR)/Current_ert_rtw/coderassumptions/%.asm
	$(AS) $(ASFLAGS) --output_file="$@" "$<"


%.obj : $(START_DIR)/Current_ert_rtw/coderassumptions/%.cpp
	$(CPP) $(CPPFLAGS) --output_file="$@" "$<"


%.obj : $(START_DIR)/Current_ert_rtw/coderassumptions/lib/%.cla
	$(CC) $(CFLAGS) --output_file="$@" "$<"


%.obj : $(START_DIR)/Current_ert_rtw/coderassumptions/lib/%.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


%.obj : $(START_DIR)/Current_ert_rtw/coderassumptions/lib/%.asm
	$(AS) $(ASFLAGS) --output_file="$@" "$<"


%.obj : $(START_DIR)/Current_ert_rtw/coderassumptions/lib/%.cpp
	$(CPP) $(CPPFLAGS) --output_file="$@" "$<"
...
Current_ca.obj : $(START_DIR)/Current_ert_rtw/coderassumptions/Current_ca.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"
