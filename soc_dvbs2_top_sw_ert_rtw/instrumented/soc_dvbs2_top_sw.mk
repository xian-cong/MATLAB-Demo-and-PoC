###########################################################################
## Makefile generated for component 'soc_dvbs2_top_sw'. 
## 
## Makefile     : soc_dvbs2_top_sw.mk
## Generated on : Fri Dec 05 09:39:57 2025
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/soc_dvbs2_top_sw.elf
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/soc_dvbs2_top_sw.elf
...
INCLUDES_BUILDINFO = -I$(MATLAB_ROOT)/toolbox/shared/soc/processor/include -I$(MATLAB_ROOT)/toolbox/target/shared/ioplayback/include -IC:/ProgramData/MATLAB/SupportPackages/R2025b/toolbox/shared/libiio/base/include -I$(START_DIR)/slprj/ert/soc_dvbs2_proc -I$(START_DIR) -I$(START_DIR)/soc_dvbs2_top_sw_ert_rtw -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert -I$(MATLAB_ROOT)/toolbox/coder/rtiostream/src -I$(MATLAB_ROOT)/toolbox/coder/rtiostream/src/utils -I$(START_DIR)/slprj/ert/_sharedutils -IC:/ProgramData/MATLAB/SupportPackages/R2025b/toolbox/target/supportpackages/zynq/src -IC:/ProgramData/MATLAB/SupportPackages/R2025b/toolbox/target/supportpackages/zynq/include -IC:/ProgramData/MATLAB/SupportPackages/R2025b/toolbox/target/supportpackages/arm_cortex_a/include -I$(MATLAB_ROOT)/toolbox/target/codertarget/rtos/inc -I$(MATLAB_ROOT)/toolbox/target/shared/armcortexabase/include
...
DEFINES_STANDARD = -DMODEL=soc_dvbs2_top_sw -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
SRCS = $(START_DIR)/soc_dvbs2_top_sw_ert_rtw/soc_dvbs2_top_sw.c $(START_DIR)/soc_dvbs2_top_sw_ert_rtw/soc_dvbs2_top_sw_tgtconn.c $(MATLAB_ROOT)/rtw/c/src/ext_mode/common/ext_svr.c $(MATLAB_ROOT)/rtw/c/src/ext_mode/common/updown.c $(MATLAB_ROOT)/rtw/c/src/ext_mode/common/ext_work.c $(MATLAB_ROOT)/toolbox/coder/rtiostream/src/utils/rtiostream_utils.c $(MATLAB_ROOT)/toolbox/target/codertarget/rtos/src/linuxinitialize.c $(MATLAB_ROOT)/rtw/c/src/ext_mode/common/rtiostream_interface.c $(MATLAB_ROOT)/toolbox/coder/rtiostream/src/rtiostreamtcpip/rtiostream_tcpip.c profile_timer.c code_profiling_utility_functions.c

MAIN_SRC = $(START_DIR)/soc_dvbs2_top_sw_ert_rtw/ert_main.c
...
OBJS = soc_dvbs2_top_sw.c.o soc_dvbs2_top_sw_tgtconn.c.o ext_svr.c.o updown.c.o ext_work.c.o rtiostream_utils.c.o linuxinitialize.c.o rtiostream_interface.c.o rtiostream_tcpip.c.o profile_timer.c.o code_profiling_utility_functions.c.o
...
MODELREF_LIBS = ../../slprj/ert/soc_dvbs2_proc/instrumented/soc_dvbs2_proc_rtwlib.lib

LIBS = C:/ProgramData/MATLAB/SupportPackages/R2025b/toolbox/soc/supportpackages/mpsoc/bin/libcodertarget_StreamingProfilerAppSvc.lib C:/ProgramData/MATLAB/SupportPackages/R2025b/toolbox/shared/supportpackages/mpsoc/bin/libcodertarget_TargetServices.lib
...
$(PRODUCT) : $(OBJS) $(PREBUILT_OBJS) $(MODELREF_LIBS) $(LIBS) $(MAIN_OBJ)
	...
	$(LD) $(LDFLAGS) -o $(PRODUCT) $(OBJS) $(MAIN_OBJ) ../../slprj/ert/soc_dvbs2_proc/instrumented/soc_dvbs2_proc_rtwlib.lib $(LIBS) $(SYSTEM_LIBS) $(TOOLCHAIN_LIBS)
...
%.c.o : $(START_DIR)/soc_dvbs2_top_sw_ert_rtw/%.c
	$(CC) $(CFLAGS) -o $@ $<


%.s.o : $(START_DIR)/soc_dvbs2_top_sw_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o $@ $<


%.pp.o : $(START_DIR)/soc_dvbs2_top_sw_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<
...
%.c.o : $(MATLAB_ROOT)/toolbox/target/shared/armcortexabase/src/%.c
	$(CC) $(CFLAGS) -o $@ $<


%.s.o : $(MATLAB_ROOT)/toolbox/target/shared/armcortexabase/src/%.s
	$(AS) $(ASFLAGS) -o $@ $<


%.pp.o : $(MATLAB_ROOT)/toolbox/target/shared/armcortexabase/src/%.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<


ert_main.c.o : $(START_DIR)/soc_dvbs2_top_sw_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o $@ $<


soc_dvbs2_top_sw.c.o : $(START_DIR)/soc_dvbs2_top_sw_ert_rtw/soc_dvbs2_top_sw.c
	$(CC) $(CFLAGS) -o $@ $<


soc_dvbs2_top_sw_tgtconn.c.o : $(START_DIR)/soc_dvbs2_top_sw_ert_rtw/soc_dvbs2_top_sw_tgtconn.c
	$(CC) $(CFLAGS) -o $@ $<
